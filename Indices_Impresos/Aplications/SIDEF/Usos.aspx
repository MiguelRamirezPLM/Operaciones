<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Usos.aspx.cs" Inherits="Usos" %>
...
<body>
    ...
    <div>
	    ...
	    <tr><td><table width="100%">
		    <tr><td align="center" class="Titulo">&Iacute;NDICE DE USOS</td></tr>
	    ...
	    <ItemTemplate>
	        ...
	        <tr>
	        <td>
	            <span class="Rubro"><%# DataBinder.Eval(Container.DataItem, "Uso").ToString().ToUpper()%></span>
	        </td>
	        </tr>
	        <tr>
