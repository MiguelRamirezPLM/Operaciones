...
public partial class Secciones : System.Web.UI.Page
{
    ...
    protected void btnMP_Click(object sender, EventArgs e)
    {
        ...
        SecLetters generateMP = new SecLetters(this.Server.MapPath("./HtmlTemplates/Secciones/lettersMP.htm"), this.Server.MapPath("./Secciones/Seccion_MP"));
        generateMP.getHtmlFilesMP(edition, (int)Section.Materias_Primas, "MATERIAS PRIMAS");

        Sections generateSMP = new Sections(this.Server.MapPath("./HtmlTemplates/Secciones/Subseccion.htm"), this.Server.MapPath("./Secciones/Seccion_MP"));
        generateSMP.getHtmlFilesSections(edition, (int)Section.Materias_Primas, "MATERIAS PRIMAS");

        Sections generateSSMP = new Sections(this.Server.MapPath("./HtmlTemplates/Secciones/Subseccion.htm"), this.Server.MapPath("./Secciones/Seccion_MP"));
    ...
    protected void btnMaq_Click(object sender, EventArgs e)
    {
        ...
        SecLetters generateMaq = new SecLetters(this.Server.MapPath("./HtmlTemplates/Secciones/Subseccion.htm"), this.Server.MapPath("./Secciones/Seccion_Maq"));
        generateMaq.getHtmlFilesSections(edition, (int)Section.Maquinaria, "MAQUINARIA");

        Sections generateSMaq = new Sections(this.Server.MapPath("./HtmlTemplates/Secciones/Subseccion.htm"), this.Server.MapPath("./Secciones/Seccion_Maq"));
    ...
    protected void btnCC_Click(object sender, EventArgs e)
    {
        ...
        SecLetters generateCC = new SecLetters(this.Server.MapPath("./HtmlTemplates/Secciones/Subseccion.htm"), this.Server.MapPath("./Secciones/Seccion_CC"));
        generateCC.getHtmlFilesSectionsCC(edition, (int)Section.Control_Calidad, "CONTROL DE CALIDAD");

        Sections generateSCC = new Sections(this.Server.MapPath("./HtmlTemplates/Secciones/Subseccion.htm"), this.Server.MapPath("./Secciones/Seccion_CC"));
    ...
    protected void btnEE_Click(object sender, EventArgs e)
    {
        ...
        SecLetters generateEE = new SecLetters(this.Server.MapPath("./HtmlTemplates/Secciones/Subseccion.htm"), this.Server.MapPath("./Secciones/Seccion_EE"));
        generateEE.getHtmlFilesSectionsEE(edition, (int)Section.Envases_Embalajes, "ENVASES Y EMBALAJES");

        Sections generateSEE = new Sections(this.Server.MapPath("./HtmlTemplates/Secciones/Subseccion.htm"), this.Server.MapPath("./Secciones/Seccion_EE"));
    ...
    protected void btnServ_Click(object sender, EventArgs e)
    {
        ...
        SecLetters generateServ = new SecLetters(this.Server.MapPath("./HtmlTemplates/Secciones/Subseccion.htm"), this.Server.MapPath("./Secciones/Seccion_Serv"));
        generateServ.getHtmlFilesSections(edition, (int)Section.Servicios, "SERVICIOS");

        Sections generateSServ = new Sections(this.Server.MapPath("./HtmlTemplates/Secciones/Subseccion.htm"), this.Server.MapPath("./Secciones/Seccion_Serv"));
