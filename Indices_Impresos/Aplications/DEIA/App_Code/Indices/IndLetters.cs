...
public class IndLetters : GenerateHTML
{
    ...
    protected string tercerasLink(DEIA.CompanyIndexesRow companyRow)
    {
        ...
        {
            sb.Append("\r\n<tr><td>");
            sb.Append("\r\n<a href=\"" + companyRow.CompanyId.ToString() + "\" style='text-decoration:none;'><b>" +
        ...
        {
            sb.Append("\r\n<tr><td>");
            sb.Append("\r\n<a href=\"" + companyRow.HtmlFile + ".html\" style='text-decoration:none;'><b>" +
                this.replaceAccentsToHtmlCodes(companyRow.CompanyName) + "</b></a>");
            sb.Append("\r\n</td></tr>");
    ...
    {
        StringBuilder sbAntTemp = new StringBuilder(this.getHtmlTemplate(@"C:\PLM Development\Discos\DEIA\HtmlTemplates\Indices\ClienteAnterior.htm"));
