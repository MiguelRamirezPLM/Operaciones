...
public partial class PEV_IndTheraPEV : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this._tt = this.Request.QueryString["TableT"] == null ? null : this.Request.QueryString["TableT"];
        this._typet = this.Request.QueryString["TypeT"] == null ? null : this.Request.QueryString["TypeT"];

        if (this._editionId > 0)
        {
    

                GetPEV.Instance.generateTheraTmp(this._editionId, _tt, _typet);
                this.rptTerN0.DataSource = GetPEV.Instance.getAlphabet(_tt);
 ...
 GetPEV.Instance.deleteTheraTmp(this._tt);
    ...
    protected void rptTerN0_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.TherapeuticsN0.AddTherapeuticsN0Row(terN0Row.ItemArray[1].ToString());
            ...
            rptTherN1.DataSource = GetPEV.Instance.getTherapeuticsByParentId(Convert.ToInt32(terN0Row.ItemArray[0].ToString()), this._tt);
            rptTherN1.DataBind();
    ...
    protected void rptProdN0_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.ProductsN0.AddProductsN0Row(ProN0Row.ItemArray[1].ToString(), ProN0Row.ItemArray[2].ToString() , setToken(ProN0Row.ItemArray[3].ToString()),
            ProN0Row.ItemArray[4].ToString(), ProN0Row.ItemArray[5].ToString(), ProN0Row.ItemArray[6].ToString(), (XMLTheraPEV.TherapeuticsN0Row)_ds.TherapeuticsN0.Rows[_cont]);
    ...
    protected void rptTerN1_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.TherapeuticsN1.AddTherapeuticsN1Row(terN1Row.ItemArray[1].ToString(), (XMLTheraPEV.TherapeuticsN0Row)_ds.TherapeuticsN0.Rows[_cont]);
            ...
            rptTerN2.DataSource = GetPEV.Instance.getTherapeuticsByParentId(Convert.ToInt32(terN1Row.ItemArray[0].ToString()), this._tt);
            rptTerN2.DataBind(); 
    ...
    protected void rptProdN1_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.ProductsN1.AddProductsN1Row(ProN1Row.ItemArray[1].ToString(), ProN1Row.ItemArray[2].ToString(), setToken(ProN1Row.ItemArray[3].ToString()),
            ProN1Row.ItemArray[4].ToString(), ProN1Row.ItemArray[5].ToString(), ProN1Row.ItemArray[6].ToString(), (XMLTheraPEV.TherapeuticsN1Row)_ds.TherapeuticsN1.Rows[_cont2]);
    ...
    protected void rptTerN2_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.TherapeuticsN2.AddTherapeuticsN2Row(terN2Row.ItemArray[1].ToString(), (XMLTheraPEV.TherapeuticsN1Row)_ds.TherapeuticsN1.Rows[_cont2]);
            ...
            rptTerN3.DataSource = GetPEV.Instance.getTherapeuticsByParentId(Convert.ToInt32(terN2Row.ItemArray[0].ToString()), this._tt);
            rptTerN3.DataBind(); 
    ...
    protected void rptProdN2_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.ProductsN2.AddProductsN2Row(prodN2Row.ItemArray[1].ToString(), prodN2Row.ItemArray[2].ToString(),
            setToken(prodN2Row.ItemArray[3].ToString()), prodN2Row.ItemArray[4].ToString(), prodN2Row.ItemArray[5].ToString(), prodN2Row.ItemArray[6].ToString(), (XMLTheraPEV.TherapeuticsN2Row)_ds.TherapeuticsN2.Rows[_cont3]);
    ...
    protected void rptTerN3_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        DataRow terN3Row = rowView.Row;
         ...
         _ds.TherapeuticsN3.AddTherapeuticsN3Row(terN3Row.ItemArray[1].ToString(), (XMLTheraPEV.TherapeuticsN2Row)_ds.TherapeuticsN2.Rows[_cont3]);
             ...
             Repeater rptTerN4 = (Repeater)e.Item.FindControl("rptTerN4");
             rptTerN4.DataSource = GetPEV.Instance.getTherapeuticsByParentId(Convert.ToInt32(terN3Row.ItemArray[0].ToString()), this._tt);
             rptTerN4.DataBind();
    ...
    protected void rptProdN3_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.ProductsN3.AddProductsN3Row(prodN3Row.ItemArray[1].ToString(), prodN3Row.ItemArray[2].ToString(),
            setToken(prodN3Row.ItemArray[3].ToString()), prodN3Row.ItemArray[4].ToString(), prodN3Row.ItemArray[5].ToString(), prodN3Row.ItemArray[6].ToString(), (XMLTheraPEV.TherapeuticsN3Row)_ds.TherapeuticsN3.Rows[_cont4]);

        _ds.WriteXml(System.Configuration.ConfigurationManager.AppSettings["General"] + "Therapeutics.xml");
    }
 
    protected void rptTerN4_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        DataRowView rowView = (DataRowView)e.Item.DataItem;
        DataRow terN4Row = rowView.Row;


         _ds.TherapeuticsN4.AddTherapeuticsN4Row(terN4Row.ItemArray[1].ToString(), (XMLTheraPEV.TherapeuticsN3Row)_ds.TherapeuticsN3.Rows[_cont4]);

          
             Repeater rptProdN4 = (Repeater)e.Item.FindControl("rptProdN4");
             rptProdN4.DataSource = GetPEV.Instance.getInformation(Convert.ToInt32(terN4Row.ItemArray[0].ToString()), this._editionId);
             rptProdN4.DataBind();
    ...
    protected void rptProdN4_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        DataRowView rowView = (DataRowView)e.Item.DataItem;
        DataRow prodN4Row = rowView.Row;

        _ds.ProductsN4.AddProductsN4Row(prodN4Row.ItemArray[1].ToString(), prodN4Row.ItemArray[2].ToString(),
            setToken(prodN4Row.ItemArray[3].ToString()), prodN4Row.ItemArray[4].ToString(), prodN4Row.ItemArray[5].ToString(), prodN4Row.ItemArray[6].ToString(), (XMLTheraPEV.TherapeuticsN4Row)_ds.TherapeuticsN4.Rows[_cont5]);
