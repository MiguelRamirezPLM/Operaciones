...
<body>
    ...
    <div>
        ...
        <asp:Repeater runat="server" ID="rptLetter" OnItemDataBound="rptLetter_ItemDataBound">
         <ItemTemplate>
         <img alt="" src='<%# DataBinder.Eval(Container.DataItem, "Letter") %>'style="border:0; " width="25%" /> 
            <asp:Repeater runat="server" ID="rptMarcas" OnItemDataBound="rptMarcas_ItemDataBound">
                <ItemTemplate>
                    <table>
                    <tr><td style="width:600px">
                     <img alt="" src='C:\Guia 58\Logos\<%# DataBinder.Eval(Container.DataItem, "logo") %>'style="border:0; " width="25%" />    
