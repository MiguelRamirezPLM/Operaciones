...
<body>
    ...
    <div>
        ...
        <ItemTemplate>
            ...
            <ItemTemplate>
                <asp:Label ID="lblCompany" runat="server"><%# DataBinder.Eval(Container.DataItem, "CompanyName")%></asp:Label>
                <br />
               <%-- <asp:Repeater ID="rptSCompany" runat="server" OnItemDataBound="rptSCompany_ItemDataBound">
                <ItemTemplate>
                    <asp:Label ID="lblSCompany" runat="server"><%# DataBinder.Eval(Container.DataItem, "CompanyName")%></asp:Label>
                </ItemTemplate>
                </asp:Repeater>--%>
                <br />
