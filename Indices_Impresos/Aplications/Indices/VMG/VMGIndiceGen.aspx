<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VMGIndiceGen.aspx.cs" Inherits="VMG_VMGIndiceGen" %>
...
<body>
    ...
    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Strikeout="False"
            ForeColor="#0000C0" Text="ÍNDICE DE PRODUCTOS GENÉRICOS"></asp:Label><br />
        <br />
        <br />
        <table>
        <tr>
