...
public class WIDataAccessAdapter<T> : WIDataAccess<T>
{
    ...
    protected static readonly Database DEF55InstanceDatabase =
        DatabaseFactory.CreateDatabase("PLMConectorDB.Properties.Settings.DEFConnectionString");
}
