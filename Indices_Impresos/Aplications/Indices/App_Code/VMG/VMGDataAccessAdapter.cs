...
public class VMGDataAccessAdapter<T> : VMGDataAccess<T>
{
    ...
    protected static readonly Database VMGInstanceDatabase =
        DatabaseFactory.CreateDatabase("PLMConectorDB.Properties.Settings.VMGConnectionString");
}
