<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndiceIndCAD.aspx.cs" Inherits="CAD_IndiceIndCAD" %>
...
<body>
    ...
    <div>
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Strikeout="False"
            ForeColor="#0000C0" Text="ÍNDICE DE INDICACIONES DEF 55"></asp:Label><br />
        <br />
