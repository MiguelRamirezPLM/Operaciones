...
public partial class IndProducts : System.Web.UI.Page
{
    ...
    protected void rptProds_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        rptComp.DataSource = Catalogs.Instance.getBrandsByProdId(Convert.ToInt32(prodRow.ItemArray[1]));
        rptComp.DataBind();

        Repeater rptSubProds = (Repeater)e.Item.FindControl("rptSubProds");
        rptSubProds.DataSource = Catalogs.Instance.getSubProducts(prodRow.ItemArray[1].ToString());
    ...
    protected void rptCompa_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds2.WriteXml(System.Configuration.ConfigurationManager.AppSettings["XML"] + "indProd8.xml");
    ...
    protected void rptSubProds_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        rptCompSubP.DataSource = Catalogs.Instance.getSBrandsByProdId(Convert.ToInt32(rowSubProds.ItemArray[1]), Convert.ToInt32(rowSubProds.ItemArray[2]));
