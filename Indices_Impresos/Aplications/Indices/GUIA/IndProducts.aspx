         ...
         <ItemTemplate>
            ...
            <asp:Repeater runat="server" ID="rptProds" OnItemDataBound="rptProds_ItemDataBound">
                <ItemTemplate>
                    <table>
                    <tr><br /><td>
                    <asp:Label runat="server" ID="lblProd" CssClass="labelSubTitle"><%# DataBinder.Eval(Container.DataItem, "productName")%></asp:Label></td></tr><br />
                     <tr><td>
                     <asp:Repeater ID="rptCompany" runat="server" OnItemDataBound="rptCompa_ItemDataBound">
                     <ItemTemplate>
                            <table>
                            <tr><br /><td>
            q                <asp:Label runat="server" ID="lblProd" CssClass="labelSubTitle"><%# DataBinder.Eval(Container.DataItem, "companyName")%></asp:Label></td></tr><br />
                            <tr><td>
                            </td></tr></table>    
                     </ItemTemplate>
                     </asp:Repeater>       
