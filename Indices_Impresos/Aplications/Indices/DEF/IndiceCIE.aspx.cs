...
public partial class DEF_CIE : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e) 
    {
       ...
       // _editionId = 82;
        ...
        {
            this.rptCIEN0.DataSource = CIEIndice.Instance.getAlphabetCIE(this._editionId);
    ...
    protected void rptCIEN0_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
       ...
       // _ds.CIEN0.AddCIEN0Row(cieN0Row.ItemArray[1].ToString().ToUpper() + " - " + cieN0Row.ItemArray[0].ToString().ToUpper());
        ...
        _ds.CIEN0.AddCIEN0Row(cieN0Row.ItemArray[0].ToString().ToUpper());
    ...
    protected void rptCIEN1_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.CIEN1.AddCIEN1Row(cieN1Row.ItemArray[0].ToString().ToUpper(),
            (CIE.CIEN0Row)_ds.CIEN0.Rows[_cont]);
        ...
        rptCIEN2.DataSource = CIEIndice.Instance.getCIEByParentIdN2(Convert.ToInt32(cieN1Row.ItemArray[2].ToString()), this._editionId);
        rptCIEN2.DataBind();
        _cont2 += 1;
    ...
    protected void rptCIEN2_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.CIEN2.AddCIEN2Row(cieN2Row.ItemArray[0].ToString().ToUpper(),
          (CIE.CIEN1Row)_ds.CIEN1.Rows[_cont2]);
    ...
    protected void rptProdN1_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.ProductsN1.AddProductsN1Row(prodN1Row.ItemArray[0].ToString(),
            prodN1Row.ItemArray[1].ToString(),
            prodN1Row.ItemArray[2].ToString(), prodN1Row.ItemArray[3].ToString(), prodN1Row.ItemArray[4].ToString(), (CIE.CIEN1Row)_ds.CIEN1.Rows[_cont2]);

        _ds.WriteXml(System.Configuration.ConfigurationManager.AppSettings["CIE"] + "CIE.xml");
    }
    ...
    protected void rptProdN2_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.ProductsN2.AddProductsN2Row(prodN2Row.ItemArray[0].ToString(),
            prodN2Row.ItemArray[1].ToString(),
            prodN2Row.ItemArray[2].ToString(), prodN2Row.ItemArray[3].ToString(), prodN2Row.ItemArray[4].ToString(), (CIE.CIEN2Row)_ds.CIEN2.Rows[_cont3]);
