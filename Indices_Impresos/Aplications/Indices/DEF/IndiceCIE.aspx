        ...
        <asp:Repeater runat="server" ID="rptCIEN0" OnItemDataBound="rptCIEN0_ItemDataBound" >
            <ItemTemplate>
                ...
                <tr><td style="width:600px">
                 </td></tr><tr><br /><td><b>CAPITULO</b><asp:Label runat="server" ID="lblCIEN0" CssClass="labelSubTitle"><%# DataBinder.Eval(Container.DataItem, "SPANISHDESCRIPTION")%></asp:Label></td></tr><br />
                 <tr><td>
                       <asp:Repeater runat="server" ID="rptCIEN1" OnItemDataBound="rptCIEN1_ItemDataBound" >
                        <ItemTemplate>                   
                            <table>
                            <tr>
                            <td ><b>NIVEL 1</b><asp:Label runat="server" ID="lblCIEN1" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "SPANISHDESCRIPTION")%></asp:Label>
                            </td><br />    
                            </tr>
                                <tr>
                                <td>
                            ...
                            <asp:Repeater runat="server" ID="rptCIEN2" OnItemDataBound="rptCIEN2_ItemDataBound">
                                    ...
                                    <tr>
                                    <td ><b>NIVEL 2</b>
                                        <asp:Label runat="server" ID="lblCIEN2" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "SPANISHDESCRIPTION")%></asp:Label>
                                    </td><br />
                                    </tr>
