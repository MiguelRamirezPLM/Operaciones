<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WIIGeneral.aspx.cs" Inherits="WESTINDIES_WIIGeneral" %>
...
<body>
    ...
    <div>
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Strikeout="False"
            ForeColor="#0000C0" Text="ÍNDICE DE PRODUCTOS DEF 55"></asp:Label><br />
        <br />
        <br />
        <table>
        <tr>
