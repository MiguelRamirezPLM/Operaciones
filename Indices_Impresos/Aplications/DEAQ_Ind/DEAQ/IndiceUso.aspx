<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndiceUso.aspx.cs" Inherits="DEAQ_IndiceUso" %>
        ...
        <asp:Repeater runat="server" ID="rptLet" OnItemDataBound="rptLet_ItemDataBound">
            <ItemTemplate>
                ...
                <ItemTemplate>
                    <table>
                    <tr><td style="width:600px">
                     </td></tr><tr><br /><td><asp:Label runat="server" ID="lblIndic" CssClass="labelSubTitle"><%# DataBinder.Eval(Container.DataItem, "Usos")%></asp:Label></td></tr><br />
                     <tr><td>
