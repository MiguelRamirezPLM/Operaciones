...
public partial class DEAQ_IndiceCult : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this.rptLet.DataSource = IndiceCultivos.Instance.getAlphabetSeeds(this._editionId);
    ...
    protected void rptLet_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        Repeater rptInd = (Repeater)e.Item.FindControl("rptCult");
            ...
            rptInd.DataSource = IndiceCultivos.Instance.getCultivoSeeds(cultRow.ItemArray[0].ToString(), this._editionId);
    ...
    protected void rptCult_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        rptProd.DataSource = IndiceCultivos.Instance.getProductsSeeds(Convert.ToInt32(cultRow.ItemArray[0].ToString()), this._editionId);
    ...
    protected void rptProds_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.Producto.AddProductoRow(infRow.ItemArray[0].ToString(), infRow.ItemArray[1].ToString(), infRow.ItemArray[1].ToString(),
            infRow.ItemArray[2].ToString(), infRow.ItemArray[3].ToString(), (IndCultivos.CultivoRow)_ds.Cultivo.Rows[_cont2]);
       ...
       // _dsC.Producto.AddProductoRow(infRow.ItemArray[0].ToString(), infRow.ItemArray[1].ToString(),
        ...
        _ds.WriteXml(System.Configuration.ConfigurationManager.AppSettings["DEAQGen"] + "CultivosDEAQSemillas.xml");
