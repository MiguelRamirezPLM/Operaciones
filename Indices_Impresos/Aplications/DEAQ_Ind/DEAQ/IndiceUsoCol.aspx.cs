...
public partial class IndiceUsoCol : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this.rptLet.DataSource = IndiceUsosCol.Instance.getAlphabet(this._editionId);
    ...
    protected void rptLet_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        rptUso.DataSource = IndiceUsosCol.Instance.getUsos(cultRow.ItemArray[0].ToString(), this._editionId);
        rptUso.DataBind();
    ...
    protected void rptUso_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        rptProd.DataSource = IndiceUsosCol.Instance.getProducts(Convert.ToInt32(usoRow.ItemArray[0].ToString()), this._editionId);
        rptProd.DataBind();
        
        Repeater rptSubUso = (Repeater)e.Item.FindControl("rptSubUso");
        rptSubUso.DataSource = IndiceUsosCol.Instance.getSubUsos(Convert.ToInt32(usoRow.ItemArray[0].ToString()), this._editionId);
        rptSubUso.DataBind();
        _cont += 1;
    ...
    protected void rptSubUso_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        rptProdN2.DataSource = IndiceUsosCol.Instance.getProducts(Convert.ToInt32(subUsoRow.ItemArray[0].ToString()), this._editionId);
        rptProdN2.DataBind();
        _cont2 += 1;
    ...
    protected void rptProdsN2_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.WriteXml(System.Configuration.ConfigurationManager.AppSettings["DEAQGen"] + "UsosDEAQCol.xml");
