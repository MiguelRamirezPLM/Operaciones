<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndiceGral.aspx.cs" Inherits="DEAQ_IndiceGral" %>
...
<body>
    ...
    <div>
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Strikeout="False"
            ForeColor="#0000C0" Text="ÍNDICE DE PRODUCTOS DEAQ 20"></asp:Label><br />
        <br />
        <br />
        <table>
        <tr>
