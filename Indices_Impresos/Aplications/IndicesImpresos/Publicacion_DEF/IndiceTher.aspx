<%@ page language="C#" autoeventwireup="true" inherits="Default3, App_Web_iw2mfwhu" %>
        ...
        <asp:Repeater runat="server" ID="rptTerN0" OnItemDataBound="rptTerN0_ItemDataBound" >
            <ItemTemplate>
                ...
                <tr><td style="width:600px">
                 </td></tr><tr><br /><td><asp:Label runat="server" ID="lblTerN0" CssClass="labelSubTitle"><%# DataBinder.Eval(Container.DataItem, "SPANISHDESCRIPTION")%>.- <%# DataBinder.Eval(Container.DataItem,"THERAPEUTICKEY") %></asp:Label></td></tr><br />
                 <tr><td>
                    <asp:Repeater runat="server" ID="rptTerN1" OnItemDataBound="rptTerN1_ItemDataBound" >
                        <ItemTemplate>                   
                            <table>
                            <tr>
                            <td ><asp:Label runat="server" ID="lblTerN1" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "SPANISHDESCRIPTION")%>.- <%# DataBinder.Eval(Container.DataItem,"THERAPEUTICKEY") %></asp:Label>
                            </td><br />    
                            </tr>
                            <tr>
                            <td>
                                ...
                                <tr>
                                <td >
                                    <asp:Label runat="server" ID="lblTerN2" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "SPANISHDESCRIPTION")%>.- <%# DataBinder.Eval(Container.DataItem,"THERAPEUTICKEY") %></asp:Label>
                                </td>
                                </tr>
                                <tr>
                                <td><br /></td></tr>
                                ...
                                <td>
                                 ...
                                 <tr><td>
                                    ...
                                    <tr>
                                    <td >
                                        <asp:Label runat="server" ID="lblTerN3" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "SPANISHDESCRIPTION")%>.- <%# DataBinder.Eval(Container.DataItem,"THERAPEUTICKEY") %></asp:Label>
                                    </td>
                                    </tr>
                                    <tr>
                                    <td><br /></td></tr>
