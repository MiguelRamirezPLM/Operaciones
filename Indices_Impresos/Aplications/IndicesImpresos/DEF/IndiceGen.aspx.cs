...
public partial class IndiceGen : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this.rptLet.DataSource = GenIndice.Instance.getAlphabet(this._editionId, this._tipo);
    ...
    protected void rptLet_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        rptProd.DataSource = GenIndice.Instance.getProducts(this._editionId, letraRow.ItemArray[0].ToString(), this._tipo);
        rptProd.DataBind();
        _cont += 1;
    ...
    protected void rptProd_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.Producto.AddProductoRow(prodRow.ItemArray[1].ToString(), prodRow.ItemArray[2].ToString(),
    ...
    private int _cont;
    private GenIndices _ds = new GenIndices();
