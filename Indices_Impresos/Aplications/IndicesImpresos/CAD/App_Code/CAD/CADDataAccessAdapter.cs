...
public class CADDataAccessAdapter<T> : CADDataAccess<T>
{
    ...
    protected static readonly Database CAD40InstanceDatabase =
        DatabaseFactory.CreateDatabase("PLMConectorDB.Properties.Settings.CAD40ConnectionString");
}
