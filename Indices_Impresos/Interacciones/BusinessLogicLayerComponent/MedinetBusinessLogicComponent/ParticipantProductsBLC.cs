...
namespace MedinetBusinessLogicComponent
{
    public sealed class ParticipantProductsBLC 
    {
        ...
        {
            return MedinetDataAccessComponent.ParticipantProductsDALC.Instance.participate(productId, editionId, pharmaFormId, divisionId, categoryId);
        }
        ...
        {
            return MedinetDataAccessComponent.ParticipantProductsDALC.Instance.getOne(productId, editionId, pharmaFormId, divisionId, categoryId);
        }
        ...
        public List<PagedProductInfo> getProductPaged(int editionId, string brand)
        {
            ...
            return MedinetDataAccessComponent.ParticipantProductsDALC.Instance.getPagedProducts(editionId, brand, (byte)CatalogsBLC.TypeInEdition.Participante);
        }
        ...
        public List<PagedProductInfo> getProductPagedSymptom(int editionId, string brand)
        {
            ...
            return MedinetDataAccessComponent.ParticipantProductsDALC.Instance.getPagedProductsSymptoms(editionId, brand, (byte)CatalogsBLC.TypeInEdition.Participante);
        }
        public void addToBook(ParticipantProductsInfo BEntity,int userId, string hash)
        {
            ...
            activityLog.TableId = Convert.ToInt32(PLMUsersBusinessLogicComponent.PLMUsersBusinessLogic.Tables.ParticipantProducts);
            ...
            MedinetDataAccessComponent.ParticipantProductsDALC.Instance.insert(BEntity);
        ...
        public void addPage(ParticipantProductsInfo BEntity, int userId, string hash)
        {
            ...
            MedinetDataAccessComponent.ParticipantProductsDALC.Instance.update(BEntity);
        ...
        public void removeToBook(ParticipantProductsInfo BEntity, int userId, string hash)
        {
            ...
            MedinetDataAccessComponent.ParticipantProductsDALC.Instance.delete(BEntity);
