...
public partial class Contraindications : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this.rptLet.DataSource = GenIndice.Instance.getAlphabetC(this._editionId);
      ...
      protected void rptLet_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        //_ds.Image.AddImageRow("file:///C:/Capitulares/" + letraRow.ItemArray[0].ToString().ToLower() + ".tif", (ContraindicationsProducts.LetraRow)_ds.Letra.Rows[_cont]);
    ...
    protected void rptProd_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.Producto.AddProductoRow( prodRow.ItemArray[0].ToString(),
            prodRow.ItemArray[1].ToString(), prodRow.ItemArray[2].ToString(), prodRow.ItemArray[3].ToString(), prodRow.ItemArray[4].ToString(),
            prodRow.ItemArray[5].ToString(),prodRow.ItemArray[6].ToString(), prodRow.ItemArray[7].ToString(), prodRow.ItemArray[8].ToString(), (ContraindicationsProducts.LetraRow)_ds.Letra.Rows[_cont]);

        _ds.WriteXml(System.Configuration.ConfigurationManager.AppSettings["General"] + "Contraindications.xml");
    ...
    private int _cont;
    private ContraindicationsProducts _ds = new ContraindicationsProducts();
