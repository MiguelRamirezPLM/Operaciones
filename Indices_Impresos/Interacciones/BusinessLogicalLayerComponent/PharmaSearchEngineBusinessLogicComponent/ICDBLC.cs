...
namespace PharmaSearchEngineBusinessLogicComponent
{
    public sealed class ICDBLC
    {
        ...
        public List<MedinetBusinessEntries.ICDInfo>getICDByDrugs(string code,int editionId, int productId)

        {
            ...
            else
            {
                ...
                {
                    List<MedinetBusinessEntries.ICDInfo> ICDList = MedinetDataAccessComponent.ICDDALC.Instance.getICDByProduct(editionId,productId);
