...
namespace PLMClientsBusinessLogicComponent
{
    public class CompanyClientsBLC
    {
        ...
        public List<CompanyClientsInfo> getAllCompanyTypes(int country) 
        {
            return PLMClientsDataAccessComponent.CompanyClientsDALC.Instance.getAllCompanyTypes(country);
        }
