    ...
    public class ICDBLC
    {
      ...
      #region Methods
         ...
         public List<ICDInfo> getICDByText(int editionId, string search)
        {
         ...
         public List<ICDInfo> getICDWithOutProduct(int productId, int pharmaformId, string search)
         {
             return MedinetDataAccessComponent.ICDDALC.Instance.getICDWithOutProduct(productId, pharmaformId , search);
         }
