...
namespace MedinetBusinessLogicComponent
{
    public sealed class EditionDivisionProductsBLC
    {
        ...
        {
            return MedinetDataAccessComponent.EditionDivisionProductsDALC.Instance.checkEdiDivProd(editionId, divisionId, categoryId, productId, pharmaFormId);
        }

        public EditionDivisionProductInfo getDivision(int editionId, int divisionId, int categoryId, int productId, int pharmaFormId)
        {
            return MedinetDataAccessComponent.EditionDivisionProductsDALC.Instance.getOne(editionId, divisionId, categoryId, productId, pharmaFormId);
        }
        ...
        public void addDivision(EditionDivisionProductInfo BEntity, int userId, string hash)
        {
            ...
            activityLog.TableId = Convert.ToInt32(PLMUsersBusinessLogicComponent.PLMUsersBusinessLogic.Tables.EditionDivisionProducts);
            ...
            MedinetDataAccessComponent.EditionDivisionProductsDALC.Instance.insert(BEntity);
        ...
        public void removeDivision(EditionDivisionProductInfo BEntity, int userId, string hash)
        {
            ...
            MedinetDataAccessComponent.EditionDivisionProductsDALC.Instance.delete(BEntity);
