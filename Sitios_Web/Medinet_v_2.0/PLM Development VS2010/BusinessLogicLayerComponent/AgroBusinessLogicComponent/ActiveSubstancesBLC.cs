...
namespace AgroBusinessLogicComponent
{
    public class ActiveSubstancesBLC
    {
        ...
        public void addActiveSubstancesForProduct(int productId, int agrochemicalUseId, int userId, string hash)
        {
            ...
            activityLog.TableId = Convert.ToInt32(PLMUsersBusinessLogicComponent.PLMUsersBusinessLogic.Tables.ProductSubstancesDEAQ);
            ...
            activityLog.FieldsAffected = "(ActiveSubstanceId," + agrochemicalUseId + ");";
        ...
        public List<AgroBusinessEntries.ActiveSubstanceInfo> getActiveSubstancesNotAssociated(int editionId, int divisionId, int bookId, int productId, int pharmaformId, string brand)
        {
            if (editionId <= 0 || divisionId <= 0)
                throw new ArgumentException("The Edition or Country does not exist.");

            return AgroDataAccessComponent.ActiveSubstancesDALC.Instance.getActiveSubstancesNotAssociated(editionId, divisionId, bookId, productId, pharmaformId, brand);
        }
