...
namespace PharmaSearchEngineBusinessEntries
{
    ...
    [DataContract]
    public class PublicityProductInfo
    {

        #region Constructors

        /// <summary>
        ///     Initializes a new instance of the PublicityProductInfo class. Not receive parameters.
        /// </summary>
        public PublicityProductInfo() { }
        ...
        /// <summary>
        ///     <para>
        ///         Property which gets or sets a value for ProductImage.
        ///     </para>
        ///     <para>
        ...
        /// <summary>
        ///     <para>
        ///         Property which gets or sets a value for PublicityImage.
        ///     </para>
        ///     <para>
        ///         Image of the Product Publicity.
        ///     </para>
        /// </summary>
        [DataMember]
        public string PublicityImage
        {
            get
            {
                return this._publicityImage;
            }
            set
            {
                this._publicityImage = value;
            }
        }
        ...
        private string _publicityImage;
