...
namespace PLMClientsBusinessEntities
{
    ...
    public class EventsDetailInfo
    {
        ...
        ///     </para>
        ///     <para>
        ///         Professional practice associated with the Event.
        ///     </para>
        /// </summary>
        [DataMember]
        ...
        ///     </para>
        ///     <para>
        ///         Professional Speciality associated with the Event.
        ///     </para>
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        ///     <para>
        ///         Property which gets or sets a value for EventDistance.
        ///     </para>
        ///     <para>
        ///         Distance between the Event and the Client.
        ///     </para>
        /// </summary>
        [DataMember]
        public decimal? EventDistance
        {
            get
            {
                return this._eventDistance;
            }
            set
            {
                this._eventDistance = value;
            }
        }

        /// <summary>
        ///     <para>
        ///         Property which gets or sets a value for CompanyEvents.
        ///     </para>
        ///     <para>
        ///         It is a list of objects of type <see cref="PLMClientsBusinessEntities.CompanyEventsDetailInfo"/>. It indicates if the event has a sponsor.
        ///     </para>
        /// </summary>
        [DataMember]
        public List<PLMClientsBusinessEntities.CompanyEventsDetailInfo> CompanyEvents
        {
            get
            {
                return this._companyEvents;
            }
            set
            {
                this._companyEvents = new List<CompanyEventsDetailInfo>();
                foreach (PLMClientsBusinessEntities.CompanyEventsDetailInfo item in value)
                    this._companyEvents.Add(item);
            }
        }
        ...
        private decimal? _eventDistance;
        private List<PLMClientsBusinessEntities.CompanyEventsDetailInfo> _companyEvents;
