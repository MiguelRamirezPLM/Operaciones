...
{
    [DataContract]
    public class ClientPackUpdateInfo
    {
        #region Constructors

        public ClientPackUpdateInfo()
        {
        ...
        [DataMember]
        public EditionPackSQLTextInfo PackSqlText
        {
            get { return this._packSqlText; }
            set { this._packSqlText = value; }
        }
        ...
        private EditionPackSQLTextInfo _packSqlText = new EditionPackSQLTextInfo();
