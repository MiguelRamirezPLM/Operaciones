...
namespace MedinetBusinessEntries
{
    ...
    /// </summary>
    [DataContract]
    public class ProductPharmaGroupContraindicationInfo
    {
        #region Constructor
        public ProductPharmaGroupContraindicationInfo() { }
        #endregion

        [DataMember]
        public int PharmaGroupId
        {
            get { return this._pharmaGroupId; }
            set { this._pharmaGroupId= value; }
        }
        [DataMember]
        ...
        {
            get { return this._pharmaGroupName; }
            set { this._pharmaGroupName = value; }
        }
        ...
        private string _pharmaGroupName;
    }
}
