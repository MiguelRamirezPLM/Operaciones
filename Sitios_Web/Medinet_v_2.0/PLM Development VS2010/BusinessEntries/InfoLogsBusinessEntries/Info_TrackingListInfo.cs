...
namespace InfoLogsBusinessEntries
{
    ...
    [DataContract]
    public class Info_TrackingListInfo
    {

        #region Constructors

        /// <summary>
        ///     Initializes a new instance of the Info_TrackingListInfo class. Not receives parameters.
        /// </summary>
        public Info_TrackingListInfo() { }
        ...
        ///     </para>
        ///     <para>
        ///         Search parameters with which the query was made.
        ///     </para>
        /// </summary>
        [DataMember]
        ...
        ///     </para>
        ///     <para>
        ///         Indicates if the query was loaded in the data base.
        ///     </para>
        /// </summary>
        [DataMember]
