...
namespace AgroBusinessEntries
{
    ...
    /// <summary>
    ///     Class which represents the Division information.
    /// </summary>
    /// <remarks>
    ///     Transmits information between the application layers.
    /// </remarks>
    /// <para>
    ///         Is an division  contained in the laboratory.
    ///     </para>
    [DataContract]
    public class DivisionAddressInfo : AddressInfo
    {

        #region Constructor

        public DivisionAddressInfo() { }
