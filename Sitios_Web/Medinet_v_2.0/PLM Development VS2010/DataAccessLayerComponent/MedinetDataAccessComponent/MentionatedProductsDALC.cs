...
{
    public sealed class MentionatedProductsDALC : MedinetDataAccessAdapter<MentionatedProductInfo>
    {
        #region Constructors
        ...
        {
            DbCommand dbCmd = MentionatedProductsDALC.MedInstanceDatabase.GetStoredProcCommand("dbo.plm_spMentionatedProduct");

            MentionatedProductsDALC.MedInstanceDatabase.AddParameter(dbCmd, "@Return", DbType.Int32,
                ParameterDirection.ReturnValue, string.Empty, DataRowVersion.Current, 0);
            MentionatedProductsDALC.MedInstanceDatabase.AddParameter(dbCmd, "@productId", DbType.Int32,
                ParameterDirection.Input, string.Empty, DataRowVersion.Current, productId);
            MentionatedProductsDALC.MedInstanceDatabase.AddParameter(dbCmd, "@editionId", DbType.Int32,
                ParameterDirection.Input, string.Empty, DataRowVersion.Current, editionId);
            MentionatedProductsDALC.MedInstanceDatabase.AddParameter(dbCmd, "@pharmaFormId", DbType.Int32,
                ParameterDirection.Input, string.Empty, DataRowVersion.Current, pharmaFormId);
            MentionatedProductsDALC.MedInstanceDatabase.AddParameter(dbCmd, "@divisionId", DbType.Int32,
                ParameterDirection.Input, string.Empty, DataRowVersion.Current, divisionId);
            MentionatedProductsDALC.MedInstanceDatabase.AddParameter(dbCmd, "@categoryId", DbType.Int32,
                ParameterDirection.Input, string.Empty, DataRowVersion.Current, categoryId);

            MentionatedProductsDALC.MedInstanceDatabase.ExecuteNonQuery(dbCmd);
        ...
        public override int insert(MentionatedProductInfo businessEntity)
        {
            ...
            DbCommand dbCmd = MentionatedProductsDALC.MedInstanceDatabase.GetStoredProcCommand("dbo.plm_spCRUDMentionatedProducts");

            MentionatedProductsDALC.MedInstanceDatabase.AddParameter(dbCmd, "@Return", DbType.Int32,
                ParameterDirection.ReturnValue, string.Empty, DataRowVersion.Current, 0);
            MentionatedProductsDALC.MedInstanceDatabase.AddParameter(dbCmd, "@CRUDType", DbType.Byte,
        ...
        public MentionatedProductInfo getOne(int productId, int editionId, int pharmaFormId, int divisionId, int categoryId)
        {
            ...
            using (IDataReader dataReader = MentionatedProductsDALC.MedInstanceDatabase.ExecuteReader(dbCmd))
            {
                if (dataReader.Read())
