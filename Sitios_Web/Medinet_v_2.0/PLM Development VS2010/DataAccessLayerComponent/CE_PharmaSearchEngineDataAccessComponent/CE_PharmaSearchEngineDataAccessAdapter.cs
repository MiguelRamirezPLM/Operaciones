...
{
    public class CE_PharmaSearchEngineDataAccessAdapter<T> : CE_PharmaSearchEngineDataAccess<T>
    {
        ...
        //protected static readonly SqlCeDatabase PharmaInstanceDatabase =
        //    new SqlCeDatabase("Data Source=" + System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().GetName().CodeBase).Replace("file:\\", "") + "\\CE_Medinet.sdf;Password=m3d1n3t3;Max Database Size = 1024;Persist Security Info=False;");
