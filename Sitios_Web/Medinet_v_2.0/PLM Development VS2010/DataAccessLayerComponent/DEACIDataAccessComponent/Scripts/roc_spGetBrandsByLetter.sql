...
/* 
	...
	EXECUTE dbo.roc_spGetBrandsByLetter @page = 0,  @numberByPage = 10, @indexId = 4, @editionId = 3, @letter = a  
...
(
 ...
 WHERE b.Active='1' AND cbe.EditionId=@editionId AND cbi.IndexId=@indexId  AND b.BrandName LIKE @letter + '%'
)
AS TOTAL,* FROM 
(
