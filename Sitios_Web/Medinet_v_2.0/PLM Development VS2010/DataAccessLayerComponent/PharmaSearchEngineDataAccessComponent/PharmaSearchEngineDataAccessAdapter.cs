...
{
    public class PharmaSearchEngineDataAccessAdapter<T> : PharmaSearchEngineDataAccess<T>
    {
        ...
        protected static readonly Database MedInstanceDatabase =
            DatabaseFactory.CreateDatabase("PLMConectorDB.Properties.Settings.MedinetConnectionString");
    }
}
