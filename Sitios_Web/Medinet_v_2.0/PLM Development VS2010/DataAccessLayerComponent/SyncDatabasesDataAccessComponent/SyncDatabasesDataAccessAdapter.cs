...
{
    public class SyncDatabasesDataAccessAdapter<T> : SyncDatabasesDataAccess<T>
    {
        ...
        protected static readonly Database SyncDatabaseInstance = DatabaseFactory.CreateDatabase("PLMConectorDB.Properties.Settings.SyncConnectionString");
