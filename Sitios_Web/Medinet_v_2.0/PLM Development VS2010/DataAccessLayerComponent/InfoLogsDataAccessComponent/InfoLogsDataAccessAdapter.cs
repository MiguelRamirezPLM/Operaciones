...
{
    public class InfoLogsDataAccessAdapter<T> : InfoLogsDataAccess<T>
    {
        ...
        protected static readonly Database InstanceDatabase =
            DatabaseFactory.CreateDatabase("PLMConectorDB.Properties.Settings.InfoLogsConnectionString");
