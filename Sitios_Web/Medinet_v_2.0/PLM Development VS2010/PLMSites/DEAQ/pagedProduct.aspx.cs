...
{ 
    ...
    protected void grdProducts_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            AgroBusinessEntries.PagedProductInfo currentRow = (AgroBusinessEntries.PagedProductInfo)e.Row.DataItem;
    ...
    protected void ddlAlphabet_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            //this.grdProducts.DataSource = AgroBusinessLogicComponent.ParticipantProductsBLC.Instance.getProductPaged(this._editionId, letterToSearch);
            //this.grdProducts.DataBind();
            this.aspGrdProducts.DataSource = AgroBusinessLogicComponent.ParticipantProductsBLC.Instance.getProductPaged(this._editionId, letterToSearch);
    ...
    protected void btnSaveProducts_OnClick(object sender, EventArgs e)
    {
        ...
        for (int gridRow = 0; gridRow < this.aspGrdProducts.VisibleRowCount; gridRow++)
        {
            ...
            if (txtPage!=null)
            {
                ...
                AgroBusinessLogicComponent.ParticipantProductsBLC.Instance.addPage(participantProduct, this._userId, this._hashkey);
            }
        }
    ...
    protected void aspGrdProducts_HtmlRowCreated(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewTableRowEventArgs e)
    {
        ...
        //    if (gv != null)
        //    {
        //        gv.DataSource = AgroBusinessLogicComponent.CatalogsBLC.Instance.getSymptomsByProduct(textPro, textPha);
        //        gv.DataBind();
        //    }
