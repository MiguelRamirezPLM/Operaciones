<%@ Page Language="C#" MasterPageFile="~/medinet.master" AutoEventWireup="true" CodeFile="presentationImages.aspx.cs" Inherits="productImages" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <br />
    <br />
    <asp:Label ID="lblTitle" runat="server" Text="Agregar imagen a la presentación" Font-Names="Trebuchet MS" Font-Size="Medium" Font-Bold="true" />
    <br />
    <asp:Label ID="lblExtPack" runat="server" Text="Presentaciones" />
    <asp:DropDownList ID="ddlPresentations" runat="server" Width="200px"/>
    <div class="classname1"  >
            <asp:Label ID="Label1" runat="server" Text="Agregar Imagen" style="position:absolute; left:315px; color:white; font-weight:bold; "></asp:Label>
    ...
    <dx:ASPxGridView ID="grdPresentationCatalog" runat="server" AutoGenerateColumns="False" 
                    ...
                    KeyFieldName="PresentationId;ImageId"  >
                    ...
                    <Columns>
                            <dx:GridViewDataColumn  FieldName="PresentationId" Visible="False" VisibleIndex="-10"/>
                            <dx:GridViewDataColumn  FieldName="ProductId" Visible="False" VisibleIndex="-9" />
                            <dx:GridViewDataColumn FieldName="ImageId" Visible="False"  VisibleIndex="-8"/>
                            <dx:GridViewDataColumn  FieldName="PharmaFormId" Visible="False" VisibleIndex="-7" />
                            <dx:GridViewDataColumn  FieldName="DivisionId" Visible="False" VisibleIndex="-6" />
                            <dx:GridViewDataColumn  FieldName="CategoryId" Visible="False" VisibleIndex="-5" />
                            <dx:GridViewDataColumn  FieldName="ExternalPackId" Visible="False"  VisibleIndex="-4"/>
                            <dx:GridViewDataColumn  FieldName="InternalPackId" Visible="False" VisibleIndex="-3" />
                            <dx:GridViewDataColumn  FieldName="ContentUnitId" Visible="False" VisibleIndex="-2" />
                            <dx:GridViewDataColumn  FieldName="WeightUnitId" Visible="False" VisibleIndex="-1" />
                            <dx:GridViewDataColumn FieldName="Brand" Caption="Producto" VisibleIndex="0" Settings-AllowDragDrop="True">
                            ...
                            <dx:GridViewDataColumn FieldName="Presentation" Caption="Presentaciones" VisibleIndex="3">
                                    <CellStyle CssClass="label" HorizontalAlign="Center" VerticalAlign="Middle" />
                            </dx:GridViewDataColumn>
