...
public partial class products : System.Web.UI.Page
{
    ...
    protected void grdProducts_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        TextBox txtDescription = (TextBox)this.grdProducts.Rows[e.RowIndex].FindControl("txtDescription");
        TextBox txtRegister = (TextBox)this.grdProducts.Rows[e.RowIndex].FindControl("txtRegister");
        ...
        product.ProductName = txtBrand.Text.Trim();
        product.Description = txtDescription.Text.Trim();
        product.Register = txtRegister.Text.Trim();
        ...
        chkMentionated = (CheckBox)this.grdProducts.Rows[e.RowIndex].FindControl("Mentionated");
    ...
    protected void btnAddProduct_Click(object sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(this.txtBrandToAdd.Text.Trim()))
        {
            ...
            {
                this.addProduct();
                this.txtDescriptionToAdd.Text = "";
                this.txtRegisterToAdd.Text = "";
    ...
    protected void btnSaveParticipant_Click(object sender, EventArgs e)
    {
        ...
        //ScriptManager.RegisterStartupScript(this, typeof(Page), "messageScript", "jAlert('El producto se modifico con exito.', 'Producto guardado');", true);
    ...
    private void getProductsData()
    {
        ...
        this._ProductsInfo.ProductName = txtBrandToAdd.Text.Trim();
        this._ProductsInfo.CountryId = this._countryId;
        this._ProductsInfo.Description = null;
        this._ProductsInfo.SanitaryRegistry = null;
        this._ProductsInfo.Register = txtRegisterToAdd.Text.Trim();
        this._ProductsInfo.Description = txtDescriptionToAdd.Text.Trim();
    ...
    private void exportXls()
    {
        ...
        foreach (AgroBusinessEntries.ProductsToEditInfo prod in products)
        {
            if (prod.Participant)
            {
                ...
                dtProds.Rows.Add(prod.CategoryName, prod.Brand, prod.PharmaForm,prod.Register,prod.ProductDescription, prod.NewProduct ? "Si" : "No",  modifiedcontent ? "Si" : "No");
            }
        }
        //AgroBusinessEntries.VersionFileInfo VersionFile = AgroBusinessLogicComponent.FilesBLC.Instance.getVersionFile(getPrefixApplication(), _editionId);
        string route = Server.MapPath(System.Configuration.ConfigurationManager.AppSettings["BaseURL"]);
