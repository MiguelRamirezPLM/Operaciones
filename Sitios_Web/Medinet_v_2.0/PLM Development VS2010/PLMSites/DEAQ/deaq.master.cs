...
public partial class deaq : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            this.lblCountryName.Text = this.Session["countryId"] == null ? "" :
                AgroBusinessLogicComponent.CatalogsBLC.Instance.getCountry(Convert.ToInt32(this.Session["countryId"])).CountryName;
            ...
            this.lblNumberEdition.Text = this.Session["editionId"] == null ? "" :
               AgroBusinessLogicComponent.CatalogsBLC.Instance.getEdition(Convert.ToInt32(this.Session["editionId"])).NumberEdition.ToString();
