...
public partial class productDivisions : System.Web.UI.Page
{
    ...
    {
        //this.Session["divisionName"] = AgroBusinessLogicComponent.DivisionsBLC.Instance.getDivision(this._divisionId).ShortName;
    ...
    protected void btnSaveProducts_Click(object sender, EventArgs e)
    {
        ...
        for (int gridRow = 0; gridRow < this.grdDivisionProducts.Rows.Count; gridRow++)
        {
            ...
            {
                AgroBusinessEntries.ProductCategoriesInfo productCategory = AgroBusinessLogicComponent.ProductCategoriesBLC.Instance.getCategory(productId, pharmaFormId,
                ...
                AgroBusinessEntries.ParticipantProductsInfo participantProduct = AgroBusinessLogicComponent.ParticipantProductsBLC.Instance.getParticipantProduct(productId,
                ...
                AgroBusinessEntries.EditionDivisionProductInfo editionProduct = AgroBusinessLogicComponent.EditionDivisionProductsBLC.Instance.getDivision(this._editionId, this._divisionId,
                ...
                {
                    editionProduct = new AgroBusinessEntries.EditionDivisionProductInfo();
                    ...
                    AgroBusinessLogicComponent.EditionDivisionProductsBLC.Instance.addDivision(editionProduct, this._userId, this._hashkey);
                }
            }
        }
        this.getDivisionProducts();
    ...
    private void getDivisionProducts()
    {
        ...
        this.grdDivisionProducts.DataSource = AgroBusinessLogicComponent.ProductsBLC.Instance.getEditableDivisionProducts(this._divisionId, this._countryId,
    ...
    private void getDivisions()
    {
        ...
        this.ddlOtherDivisions.DataSource = AgroBusinessLogicComponent.CatalogsBLC.Instance.getDivisionsByCountry(this._countryId);
