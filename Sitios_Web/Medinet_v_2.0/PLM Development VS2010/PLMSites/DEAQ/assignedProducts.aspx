<%@ Page Language="C#" MasterPageFile="~/deaq.master" AutoEventWireup="true" CodeFile="assignedProducts.aspx.cs" Inherits="assignedProducts" %>
    ...
    <dx:ASPxGridView ID="aspGrdProducts" runat="server" 
        ...
        <Columns>
            ...
            <dx:GridViewDataColumn FieldName="PharmaForm" Caption="Forma Farmacéutica" VisibleIndex="1">
                <CellStyle CssClass="label" HorizontalAlign="Left" />
                <DataItemTemplate>
                    <asp:Label ID="lblPharma" Text='<%# DataBinder.Eval(Container.DataItem, "PharmaForm") %>' runat="server" >
                    </asp:Label></DataItemTemplate>
            </dx:GridViewDataColumn>

            <dx:GridViewDataColumn FieldName="DivisionShortName" Caption="Laboratorio" VisibleIndex="2">
                <CellStyle CssClass="label" HorizontalAlign="Left" />
                <DataItemTemplate>
                    <asp:Label ID="lblDivision" Text='<%# DataBinder.Eval(Container.DataItem, "DivisionShortName") %>' runat="server" >
                    </asp:Label></DataItemTemplate>
            </dx:GridViewDataColumn>
            ...
            <dx:GridViewDataCheckColumn FieldName="Agrochemicals" Caption="Usos Agroquimicos" VisibleIndex="3" >
                <PropertiesCheckEdit DisplayTextChecked="Clasificado" DisplayTextUnchecked="No Clasificado" />
            </dx:GridViewDataCheckColumn>

            <dx:GridViewDataCheckColumn FieldName="Croops" Caption="Cultivos" VisibleIndex="4" >
                <PropertiesCheckEdit DisplayTextChecked="Clasificado" DisplayTextUnchecked="No Clasificado" />
            </dx:GridViewDataCheckColumn>

             
            <dx:GridViewDataCheckColumn FieldName="Seeds" Caption="Semillas" VisibleIndex="5" >
                <PropertiesCheckEdit DisplayTextChecked="Clasificado" DisplayTextUnchecked="No Clasificado" />
            </dx:GridViewDataCheckColumn>
            <dx:GridViewDataCheckColumn FieldName="Substances" Caption="Sustancias Activas" VisibleIndex="6">
                <PropertiesCheckEdit DisplayTextChecked="Clasificado" DisplayTextUnchecked="No Clasificado" />
            </dx:GridViewDataCheckColumn>
              
          
              
            <dx:GridViewDataHyperLinkColumn Caption="Editar Clasificación" VisibleIndex="7" >
