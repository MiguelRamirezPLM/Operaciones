<%@ Page Language="C#" MasterPageFile="~/medinet.master" AutoEventWireup="true" CodeFile="classifiedLaboratoriesLogos.aspx.cs" Inherits="LaboratoriesLogos" %>
...
<script type="text/javascript" language="javascript">
    ...
    <dx:AspxGridView ID="grdProducts" runat="server" AutoGenerateColumns="False"
        ...
        OnRowEditing="grdProducts_RowEditing" KeyFieldName="DivisionId" onhtmlrowcreated="aspGrdProducts_HtmlRowCreated" SettingsPager-AlwaysShowPager="true"  >
       <SettingsBehavior SortMode="Custom" />
        ...
        <Columns>
            ...
            <dx:GridViewDataColumn FieldName="DivisionId" Visible="False" />
           
            <dx:GridViewDataColumn FieldName="Description" Caption="Razón Social">
                ...
                <DataItemTemplate>
                    ...
                    </asp:Label></DataItemTemplate></dx:GridViewDataColumn><dx:GridViewDataColumn Caption="Descripción" FieldName="ShortName">
                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#2694B4" ForeColor="White" />
                <CellStyle HorizontalAlign="Center" VerticalAlign="Middle"  />
                <DataItemTemplate>
                    <asp:Label ID="lblPharmaForm" Text=' <%# DataBinder.Eval(Container.DataItem, "ShortName")%>' runat="server">
                        
                    </asp:Label></DataItemTemplate></dx:GridViewDataColumn>
       
   
            <dx:GridViewDataColumn Caption="Imagenes" Visible="false">
                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#2694B4" ForeColor="White" />
                <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                <DataItemTemplate>
                 <asp:Label ID="lblImage" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"Logo") %>'></asp:Label>
                </DataItemTemplate>
              </dx:GridViewDataColumn>
   <dx:GridViewDataColumn Caption="IndiceImagenes" Visible="false" >
                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#2694B4" ForeColor="White" />
                <CellStyle HorizontalAlign="Center" VerticalAlign="Middle"   />
                <DataItemTemplate>
                    
                
                   <asp:Label ID="lblIm" runat="server" Text="0"></asp:Label>
                </DataItemTemplate>
             ...
             <dx:GridViewDataColumn Caption="Editar Logos" >
                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#2694B4" ForeColor="White" />
                <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True" />
                <DataItemTemplate>
                    <asp:ImageButton ID="btnAdd" runat="server" ImageUrl="~/Images/editar.gif" Text="Editar Logos" Visible="true" OnClick="btnEditDivsion_Click" />
                </DataItemTemplate>
            </dx:GridViewDataColumn>
        </Columns>
