<%@ Page Language="C#" MasterPageFile="~/medinet.master" AutoEventWireup="true" CodeFile="indications.aspx.cs" Inherits="indications" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(deleteName) {
            var agree = confirm('Has elegido eliminar a: ' + deleteName + ', ¿Confirmas que deseas eliminar esa indicación de éste producto?');
            if (agree)
                return true;
            else
                return false;
    ...
    <asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="X-Large" Font-Bold="true" Text="Índice de indicaciones" />
    <br />
    <br />
    ...
    <asp:Table ID="Table1" runat="server" BackColor="White" BorderColor="#000000" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
        ...
        <asp:TableRow HorizontalAlign="Center">
            ...
            <asp:Button ID="btnICD" runat="server" Text="Ir al índice CIE-10" OnClick="btnIcd_Click"  />        
             ...
             <asp:TableCell>
            <asp:Button ID="btnSymptomps" runat="server" Text="Ir al índice de Sintomas"  OnClick="btnSymptoms_Click" />        
            </asp:TableCell>
                <asp:TableCell>
    ...
    <table cellspacing="25px">
        <tr>
            <td>
                <asp:Label ID="Label6" runat="server" Font-Names="Trebuchet MS" Font-Size="Medium" Font-Bold="true" Text="Indicaciones asociadas" />
                <br />
                <asp:GridView ID="grdProductIndications" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                    Font-Names="Trebuchet MS" Font-Size="Smaller" DataKeyNames="IndicationId" HorizontalAlign="Left" OnRowDataBound="grdProductIndications_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Eliminar">
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="btnDeleteIndication" runat="server" CommandName="Delete" ImageUrl="~/Images/delete.gif" AlternateText="Eliminar indicación" 
                                Enabled="true" OnClick="btnDeleteIndication_OnClick" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
        ...
        <tr>
            <td>
                <asp:Panel ID="pnlSearch" runat="server" DefaultButton="btnIndication">
                    <asp:Label ID="Label7" runat="server" Font-Names="Trebuchet MS" Font-Size="Large" Font-Bold="true" Text="Catálogo de indicaciones" />
                    <asp:Table ID="Table2" runat="server" Width="250px">
                        <asp:TableRow>
                            <asp:TableCell HorizontalAlign="Left">
                                <asp:Label ID="Label2" runat="server" Text="Buscar una indicación" Font-Names="Trebuchet MS" Font-Size="Smaller" Font-Bold="true" />
                            ...
                            <asp:TableCell HorizontalAlign="Left">
                                <asp:TextBox ID="txtIndicationName" runat="server" Text="" Enabled="true" />
                                <asp:Button ID="btnIndication" runat="server" ToolTip="Consultar" Text="Consultar" OnClick="btnIndication_Click" />
                            </asp:TableCell><asp:TableCell HorizontalAlign="Right">
                            ...
                            </asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:GridView ID="grdIndications" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                    Font-Names="Trebuchet MS" Font-Size="Smaller" DataKeyNames="IndicationId" HorizontalAlign="Left" OnPageIndexChanging="grdIndications_PageIndexChanging"
                    OnRowDataBound="grdIndications_RowDataBound">
                    <Columns>
                        <asp:BoundField DataField="IndicationId" Visible="False" />
                        <asp:TemplateField HeaderText="Nombre de la indicación">
                            <HeaderStyle HorizontalAlign="Left" BackColor="#2694B4" ForeColor="White" />
                            ...
                            <ItemStyle HorizontalAlign="Center" Wrap="True" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btnAddIndication" runat="server" CommandName="Add" ImageUrl="~/Images/agregar.png" AlternateText="Agregar a producto" 
                                    Enabled="true" Width="20px" OnClick="btnAddIndication_OnClick" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
