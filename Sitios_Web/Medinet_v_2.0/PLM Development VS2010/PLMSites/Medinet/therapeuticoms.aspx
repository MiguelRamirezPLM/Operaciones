<%@ Page Language="C#" MasterPageFile="~/medinet.master" AutoEventWireup="true" CodeFile="therapeuticoms.aspx.cs" Inherits="therapeuticoms" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="Label4" runat="server" Font-Names="Trebuchet MS" Font-Size="X-Large" Font-Bold="true" Text="Índice terapéutico OMS" />
    <br />
    <br />
        ...
        <tr>
            <td>
                ...
                <asp:GridView ID="grdProductTherapeutics" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                    Font-Names="Trebuchet MS" Font-Size="Smaller" DataKeyNames="TherapeuticOMSId" HorizontalAlign="Left" OnRowDataBound="grdProductTherapeutics_RowDataBound">
                    <Columns>
                        <asp:BoundField DataField="TherapeuticOMSId" Visible="False" />
