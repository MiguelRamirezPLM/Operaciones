...
public partial class encyclopediaImages1 : System.Web.UI.Page
{
    ...
    protected void grdProducts_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        this.getEncyclopediasByCountry();
    }
    ...
    protected void btnEditEncyclopedia_Click(object sender, EventArgs e)
    {
        ImageButton btn = (ImageButton)sender;
        GridViewDataRowTemplateContainer Row = (GridViewDataRowTemplateContainer)btn.NamingContainer;

        this.Session["EncyclopediaId"] = (int)grdProducts.GetRowValues(Row.VisibleIndex, "EncyclopediaId");
        this.Response.Redirect("encyclopediaImages2.aspx");
    }
    ...
    private void getEncyclopediasByCountry()
{
       this.grdProducts.DataSource = MedinetBusinessLogicComponent.CatalogsBLC.Instance.getEncyclopediasByCountry(this._countryId, this._bookId, this._editionId);
