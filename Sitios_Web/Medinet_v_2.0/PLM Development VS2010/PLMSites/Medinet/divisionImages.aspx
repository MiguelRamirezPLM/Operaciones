<%@ Page Language="C#" MasterPageFile="~/medinet.master" AutoEventWireup="true" CodeFile="divisionImages.aspx.cs" Inherits="divisionImages" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
  ...
  <asp:ImageButton ID="imgBtnBackProducts" runat="server" ImageUrl="images/regresar.png" ToolTip="Regresar a productos" OnClick="imgBtnBackProducts_Click" />
    ...
    <br />
    <br />
    <asp:Label ID="lblTitle" runat="server" Text="Agregar logo a la division" Font-Names="Trebuchet MS" Font-Size="Medium" Font-Bold="true" />
   <br />
    ...
    <dx:ASPxGridView ID="grdPresentationCatalog" runat="server" AutoGenerateColumns="False" 
                    ClientInstanceName="grdPresentationCatalog"
                     OnRowDeleting="grdDeletingRow_click"
                        OnHtmlRowPrepared="aspGrdProducts_HtmlRowPrepared"
                       EnableRowsCache="false"         
                    onhtmlrowcreated="aspGrdProducts_HtmlRowCreated" 
                    onselectionchanged="aspGrdProducts_SelectionChanged" KeyFieldName="DivisionId;LogoId"  >
            ...
            <PagerTopPanel Font-Names="Verdana" Font-Size="10px" ForeColor="#7cbdd0" />
                    ...
                    <Columns>
                       <dx:GridViewDataColumn  FieldName="DivisionId" Visible="False" VisibleIndex="-2"/>
                                       ...
                                       <dx:GridViewDataColumn FieldName="LogoId" Visible="False"  VisibleIndex="-1"/>
                        
            
            <dx:GridViewDataColumn FieldName="Description" Caption="Razón Social" VisibleIndex="0" Settings-AllowDragDrop="True">
                <CellStyle CssClass="label" HorizontalAlign="Center" VerticalAlign="Middle"/>
                
            </dx:GridViewDataColumn>
            
            <dx:GridViewDataColumn FieldName="ShortName" Caption="Nombre" VisibleIndex="1">
                <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                         ...
                         <dx:GridViewDataColumn Caption="Imágenes" VisibleIndex="4" Settings-AllowDragDrop="False">
                                    ...
                                    <DataItemTemplate>
                                            ...
                                            <br />
                                        <br />
                                            <dx:ASPxTextBox ID="lblSizes" runat="server" Text=' <%# DataBinder.Eval(Container.DataItem, "LogoSizes")%>' style="display:none;" Visible="false">
                                            </dx:ASPxTextBox>
                                            <dx:ASPxTextBox ID="txtLB" runat="server" Text=' <%# DataBinder.Eval(Container.DataItem, "Logo")%>' Width="60px" style="display:none;" Visible="false">
                                            </dx:ASPxTextBox>
