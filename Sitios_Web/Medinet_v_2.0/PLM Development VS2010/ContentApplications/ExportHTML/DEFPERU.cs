            ...
            do
            {
                ...
                for (int i = 0; i < allcontent.Length; i++)
                {
                    if (allcontent.IndexOf(token, next) != -1)
                    {
                        ...
                        if (File.Exists("C:/Peru/HTMLS/" + filename + "/" +
                                    name.Trim().ToLower() + "_" + pf.Trim().ToLower() + ".htm"))
                        {
                            filecontent.saveHtmlFile("C:/Peru/HTMLS/" + filename + "/",
                ...
                filecontent.saveHtmlFile("C:/Peru/CSV/", "Archivos_" + filename + ".csv", archivo);
