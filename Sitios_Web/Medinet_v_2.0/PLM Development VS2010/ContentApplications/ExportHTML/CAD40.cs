    ...
    public class CAD40
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                string nuevo = "<p class=\"t-tulo-prod-nuevo\"";
                //string nuevo2 = "<p class=\"t-tuloprodnuevo2\"";
                string token2 = "<p class=\"forma-farmac-\">";
                string token3 = "<p class=\"antetitulo\">Informaci&oacute;n Nueva</p>";
                string token4 = "<p class=\"antetitulo\">Informaci&oacute;n Revisada</p>";

                string archivo = "NombreHTML,HTML" + Environment.NewLine;
                ...
                string name, name2, pf, pn, pf2, namebd, pharmaforms, antFile;

                int ini, ini2, next;
                int fin, fin2, med, med2;
                int len, len2, id, lenFile;
                ...
                for (int i = 0; i < allcontent.Length; i++)
                {
                    if (allcontent.IndexOf(token, next) != -1)
                    {
                        ...
                        //    {
                        //        dt.Clear();
                        //        dt = filecontent.checkNameMentionated(name2.Trim());
                        ...
                        if (next > 0)
                        {
                            ...
                            if (pn == nuevo)// || pn == nuevo2)
                            {
                                ...
                                file = file.Replace("<p class=\"antetitulo\">INFORMACI&Oacute;N NUEVA</p>", "");
                                file = file.Replace("<p class=\"antetitulo\">informaci&oacute;n revisada</p>", "");
                                file = file.Replace("<p class=\"antetitulo\">INFORMACI&Oacute;N REVISADA</p>", "");
                        ...
                        else
                        {
                            ...
                            if (pn == nuevo)// || pn == nuevo2)
                            {
                                ...
                                file = file.Replace("<p class=\"antetitulo\">INFORMACIÓN NUEVA</p>", "");
                                file = file.Replace("<p class=\"antetitulo\">información revisada</p>", "");
                                file = file.Replace("<p class=\"antetitulo\">INFORMACIÓN REVISADA</p>", "");
                                sb.Replace("@@@Contenido@@@", token3 + file);
                            }
                            else
                        ...
                        if (File.Exists("C:/CAD 40/HTMLS2/" +
                                    name.Trim().ToLower() + "_" + pf.Trim().ToLower() + ".htm"))
                        {
                            filecontent.saveHtmlFile("C:/CAD 40/HTMLS2/",
                            ...
                            archivo = archivo + name2
                                + "," + (name.Trim().ToLower() + "_" + pf.Trim().ToLower() + "_" + i.ToString() + ".htm") + Environment.NewLine;
                        }
                        else
                        {
                            ...
                            archivo = archivo + name2
                                + "," + (name.Trim().ToLower() + "_" + pf.Trim().ToLower() + ".htm") + Environment.NewLine;
                        }
                        pf = "";
                        pf2 = "";
                        name = "";
                ...
                filecontent.saveHtmlFile("C:/CAD 40/HTMLS2/", "Archivos_" + filename + ".csv", archivo);
