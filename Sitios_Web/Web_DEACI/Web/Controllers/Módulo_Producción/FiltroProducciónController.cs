...
namespace Web.Controllers.Módulo_Producción
{
    public class FiltroProducciónController : Controller
    {
        ...
        public ActionResult EliminarTeléfono(int id, int ad, int ed, int ud, string CompanyId, string PhoneTypeId)
        {
            int _CompanyId = int.Parse(CompanyId);
            ...
            return RedirectToAction("/Laboratorios/" + id + "/" + ad + "/" + ed + "/" + ud);
        }
        ...
        public ActionResult EliminarDirección(int id, int ed, int ad, int ud, string CompanyId, string AddressId)
        {
            int _CompanyId = int.Parse(CompanyId);
            int _AddressId = int.Parse(AddressId);
        ...
        public ActionResult EliminarEdiciónCliente(int EditionId, int CompanyId)
        {
            ...
            foreach (var ClientParent in _ValueParticipantClient)
            {
                if (ClientParent.CompanyIdParent == null)
                {
                    ...
                    foreach (var ClientSon in _Client)
                    {
                        ...
                        {
                            if (_deleteClient.HtmlFile != null)
                            {
                                var htmlfile = "";
                                htmlfile = _deleteClient.HtmlFile;
                                string fullPath_DEACI30 = Request.MapPath("/Terceras/DEACI_30/" + htmlfile);
                        ...
                        if (_EditionsFile.SingleOrDefault().ISBN == "DEACI 29")
                        {
                            if (_deleteClient.HtmlFile != null)
                            {
                                var htmlfile = "";
                                htmlfile = _deleteClient.HtmlFile;
                                string fullPath_DEACI29 = Request.MapPath("/Terceras/DEACI_29/" + htmlfile);
                        ...
                        if (_EditionsFile.SingleOrDefault().ISBN == "DEACI 28")
                        {
                            if (_deleteClient.HtmlFile != null)
                            {
                                var htmlfile = "";
                                htmlfile = _deleteClient.HtmlFile;
                                string fullPath_DEACI28 = Request.MapPath("/Terceras/DEACI_28/" + htmlfile);
                        ...
                        if (_EditionsFile.SingleOrDefault().ISBN == "DEACI 27")
                        {
                            if (_deleteClient.HtmlFile != null)
                            {
                                var htmlfile = "";
                                htmlfile = _deleteClient.HtmlFile;
                                string fullPath_DEACI27 = Request.MapPath("/Terceras/DEACI_27/" + htmlfile);
                        ...
                        if (_EditionsFile.SingleOrDefault().ISBN == "DEACI 26")
                        {
                            if (_deleteClient.HtmlFile != null)
                            {
                                var htmlfile = "";
                                htmlfile = _deleteClient.HtmlFile;
                                string fullPath_DEACI26 = Request.MapPath("/Terceras/DEACI_26/" + htmlfile);
                        ...
                        if (_EditionsFile.SingleOrDefault().ISBN == "DEACI 25")
                        {
                            if (_deleteClient.HtmlFile != null)
                            {
                                var htmlfile = "";
                                htmlfile = _deleteClient.HtmlFile;
                                string fullPath_DEACI25 = Request.MapPath("/Terceras/DEACI_25/" + htmlfile);
                        ...
                        if (_EditionsFile.SingleOrDefault().ISBN == "DEACI 24")
                        {
                            if (_deleteClient.HtmlFile != null)
                            {
                                var htmlfile = "";
                                htmlfile = _deleteClient.HtmlFile;
                                string fullPath_DEACI24 = Request.MapPath("/Terceras/DEACI_24/" + htmlfile);
                        ...
                        if (_EditionsFile.SingleOrDefault().ISBN == "DEACI 22")
                        {
                            if (_deleteClient.HtmlFile != null)
                            {
                                var htmlfile = "";
                                htmlfile = _deleteClient.HtmlFile;
                                string fullPath_DEACI22 = Request.MapPath("/Terceras/DEACI_22/" + htmlfile);
                        ...
                        if (_ProductsClientEditions.LongCount() > 0)
                        {
                            foreach (var _prod in _ProductsClientEditions)
                            {
                                ...
                                {
                                    if (_DeleteProductEditions.HtmlFile != null)
                                    {
                                        var htmlfile = "";
                                        htmlfile = _DeleteProductEditions.HtmlFile;
                            ...
                            foreach (var _Addss in _AdversFiles)
                            {
                                if (_Addss.AdvFile != null)
                                {
                                    ...
                                    var _Editions = (from _ed in db.Editions
                                                     where _ed.EditionId == EditionId
                                                     select _ed).ToList();
                                    if (_Editions.SingleOrDefault().ISBN == "DEACI 30")
                                    {
                                    ...
                                    if (_Editions.SingleOrDefault().ISBN == "DEACI 29")
                                    {
                                    ...
                                    if (_Editions.SingleOrDefault().ISBN == "DEACI 28")
                                    {
                                    ...
                                    if (_Editions.SingleOrDefault().ISBN == "DEACI 27")
                                    {
                                    ...
                                    if (_Editions.SingleOrDefault().ISBN == "DEACI 26")
                                    {
                                    ...
                                    if (_Editions.SingleOrDefault().ISBN == "DEACI 25")
                                    {
                                    ...
                                    if (_Editions.SingleOrDefault().ISBN == "DEACI 24")
                                    {
                                    ...
                                    if (_Editions.SingleOrDefault().ISBN == "DEACI 22")
                                    {
            ...
            var _EditionsFileClient = (from _ed in db.Editions
                                       where _ed.EditionId == EditionId
                                       select _ed).ToList();
            if (_EditionsFileClient.SingleOrDefault().ISBN == "DEACI 30")
            {
                if (_eliminarCompanyEditions.HtmlFile != null)
                {
                    var htmlfile = "";
                    htmlfile = _eliminarCompanyEditions.HtmlFile;
                    string fullPath_DEACI30 = Request.MapPath("/Terceras/DEACI_30/" + htmlfile);
                    if (System.IO.File.Exists(fullPath_DEACI30))
                    {
                        System.IO.File.Delete(fullPath_DEACI30);
            ...
            if (_EditionsFileClient.SingleOrDefault().ISBN == "DEACI 29")
            {
                if (_eliminarCompanyEditions.HtmlFile != null)
                {
                    var htmlfile = "";
            ...
            if (_EditionsFileClient.SingleOrDefault().ISBN == "DEACI 28")
            {
                if (_eliminarCompanyEditions.HtmlFile != null)
                {
                    var htmlfile = "";
            ...
            if (_EditionsFileClient.SingleOrDefault().ISBN == "DEACI 27")
            {
                if (_eliminarCompanyEditions.HtmlFile != null)
                {
                    var htmlfile = "";
            ...
            if (_EditionsFileClient.SingleOrDefault().ISBN == "DEACI 26")
            {
                if (_eliminarCompanyEditions.HtmlFile != null)
                {
                    var htmlfile = "";
            ...
            if (_EditionsFileClient.SingleOrDefault().ISBN == "DEACI 25")
            {
                if (_eliminarCompanyEditions.HtmlFile != null)
                {
                    var htmlfile = "";
            ...
            if (_EditionsFileClient.SingleOrDefault().ISBN == "DEACI 24")
            {
                if (_eliminarCompanyEditions.HtmlFile != null)
                {
                    var htmlfile = "";
            ...
            if (_EditionsFileClient.SingleOrDefault().ISBN == "DEACI 22")
            {
                if (_eliminarCompanyEditions.HtmlFile != null)
                {
                    var htmlfile = "";
