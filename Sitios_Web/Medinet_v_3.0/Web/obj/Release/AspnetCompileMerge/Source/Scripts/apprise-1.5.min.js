function apprise(string, args, callback) {
    var default_args = { 'confirm': false, 'verify': false, 'input': false, 'animate': false, 'textOk': 'Ok', 'textCancel': 'Cancel', 'textYes': 'Si', 'textNo': 'No' }
    if (args) {
    ...
    $('.appriseInner').append('<div class="aButtons"></div>'); if (args) {
        ...
        { $('.aButtons').append('<button class="btn-alert" value="ok">' + args['textOk'] + '</button>'); $('.aButtons').append('<button class="btn-alert" value="cancel">' + args['textCancel'] + '</button>'); }
        else if (args['verify'])
        { $('.aButtons').append('<button class="btn-alert" value="ok">' + args['textYes'] + '</button>'); $('.aButtons').append('<button class="btn-alert" value="cancel">' + args['textNo'] + '</button>'); }
        else
        { $('.aButtons').append('<button class="btn-alert" value="ok">' + args['textOk'] + '</button>'); }
    }
    else { $('.aButtons').append('<button class="btn-alert" value="ok">Ok</button>'); }
