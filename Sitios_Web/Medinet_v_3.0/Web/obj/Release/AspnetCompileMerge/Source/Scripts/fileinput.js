...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgImageWidthSmall: 'El ancho de la imagen: "{name}" debe de ser de {size} px.',
        msgImageHeightSmall: 'El alto de la imagen: "{name}" debe de ser de {size} px.',
        msgImageWidthLarge: 'El ancho de la imagen: "{name}" no es de {size} px.',
        msgImageHeightLarge: 'El alto de la imagen: "{name}" no es de {size} px.',
