...
namespace Web.Controllers.Medical
{
    public class MedicalController : Controller
    {
        ...
        /*
            ...
            2. plm_spCRUDProductContraindicationsByICD

            3. plm_spGetICDByProductPharmaform
        ...
        public JsonResult CheckPharmacologicalGroupsByProduct(string Product, string Category, string Division, string PharmaForm, string PharmacologicalGroup)
        {
            ...
            if (LS.LongCount() > 1)
            {
                List<GetProductPharmaGroupInteractions> LPS = db.Database.SqlQuery<GetProductPharmaGroupInteractions>("plm_spGetProductPharmaGroupInteractions  @categoryId=" + CategoryId + ",@divisionId=" + DivisionId + ",@pharmaFormId=" + PharmaFormId + ",@productId=" + ProductId + ",@susbtanceId=" + ActiveSubstanceId + "").ToList();
