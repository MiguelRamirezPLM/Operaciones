...
public partial class DEAQ_IndiceGral : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this.rptLet.DataSource = IndiceGeneral.Instance.getAlphabetSeeds(this._editionId);
    ...
    protected void rptLet_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        {
            rptProd.DataSource = IndiceGeneral.Instance.getProductsMSeeds(letraRow.ItemArray[0].ToString(), this._editionId);
        } 
    ...
    protected void rptProd_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.WriteXml(System.Configuration.ConfigurationManager.AppSettings["DEAQGen"] + "GeneralDEAQSemillas.xml");
