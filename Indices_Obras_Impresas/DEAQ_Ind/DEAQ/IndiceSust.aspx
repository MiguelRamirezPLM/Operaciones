<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndiceSust.aspx.cs" Inherits="DEAQ_IndiceSust" %>
...
<body>
    ...
    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Strikeout="False"
            ForeColor="#0000C0" Text="ÍNDICE DE SUSTANCIAS ACTIVAS DEAQ 22"></asp:Label><br />
            ...
            <ItemTemplate>
                ...
                <asp:Repeater runat="server" ID="rptSubs" OnItemDataBound="rptSubs_ItemDataBound" >
                    <ItemTemplate>
                        ...
                        <table>
                        <tr><td style="width:600px">
                         </td></tr><tr><br /><td><asp:Label runat="server" ID="lblASubs" CssClass="labelSubTitle"><%# DataBinder.Eval(Container.DataItem, "IActivo")%></asp:Label></td></tr><br />
                         <tr><td>
                            <asp:Repeater runat="server" ID="rptProds" OnItemDataBound="rptProds_ItemDataBound" >
                                <ItemTemplate>                   
                                    ...
                                    <asp:Label runat="server" ID="lblActive" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "Sustancias")%>.</asp:Label>
