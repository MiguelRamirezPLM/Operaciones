        ...
        <asp:Repeater runat="server" ID="rptTerN0" OnItemDataBound="rptTerN0_ItemDataBound" >
            <ItemTemplate>
                <table>
                    ...
                    <tr>
                        <td >Nivel 1 <asp:Label runat="server" ID="lblTerN0" ForeColor="Chocolate" CssClass="labelSubTitle"><%# DataBinder.Eval(Container.DataItem, "THERAPEUTICNAME")%></asp:Label></td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <asp:Repeater runat="server" ID="rptTerN1" OnItemDataBound="rptTerN1_ItemDataBound" >
                                <ItemTemplate>                   
                                    <table>
                                        <tr>
                                            <td style="margin-left:60px;" > NIVEL 2 <asp:Label runat="server" ID="lblTerN1" ForeColor="Orchid" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "THERAPEUTICNAME")%></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Repeater runat="server" ID="rptTerN2" OnItemDataBound="rptTerN2_ItemDataBound">
                                                    <ItemTemplate>
                                                        <table>
                                                        <tr>
                                                            <td style="margin-left:70px;">NIVEL 3
                                                                <asp:Label runat="server" ForeColor="blue" ID="lblTerN2" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "THERAPEUTICNAME")%></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                            ...
                                            <td>
                                                <asp:Repeater runat="server" ID="rptTerN3" OnItemDataBound="rptTerN3_ItemDataBound">
                                                    <ItemTemplate>
                                                        <table>
                                                        <tr>
                                                            <td style="margin-left:80px;"> NIVEL 4 
                                                                <asp:Label runat="server" ID="lblTerN3" ForeColor="green"  CssClass="label"><%# DataBinder.Eval(Container.DataItem, "TherapeuticName")%></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                              ...
                                                              <tr>
                                                                <td>
                                                                     <asp:Repeater runat="server" ID="rptTerN4" OnItemDataBound="rptTerN4_ItemDataBound">
                                                    <ItemTemplate>
                                                        <table>
                                                        <tr>
                                                            <td style="margin-left:100px;"> NIVEL 5
                                                                <asp:Label runat="server" ID="lblTerN4" ForeColor="PINK" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "TherapeuticName")%></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Repeater runat="server" ID="rptProdN4" OnItemDataBound="rptProdN4_ItemDataBound">
                                                                    <ItemTemplate>
                                                                        <table>
                                                                            <tr>
                                                                                <td >
                                                                                    <asp:Label runat="server" ID="lblBrandN4" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "ProductName")%>.</asp:Label>
                                                                                    <asp:Label runat="server" ID="lblActSubsN4" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "ACTIVESUBSTANCES")%>.</asp:Label>
                                                                                    <asp:Label runat="server" ID="lblPharmaFN4" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "PHARMAFORMS")%>.</asp:Label>
                                                                                    <asp:Label runat="server" ID="lblLabN4" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "LABORATORYNAME")%>.</asp:Label>
                                                                                    <asp:Label runat="server" ID="lblPage4" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "PAGE")%>.</asp:Label>
                                                                                </td>
