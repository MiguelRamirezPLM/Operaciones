...
public partial class DEF_CIE : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e) 
    {
       ...
       // _editionId = 82;
        ...
        {
            CIEIndice.Instance.generateCIETmp(this._editionId);
    ...
    protected void rptProdN1_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.ProductsN1.AddProductsN1Row(prodN1Row.ItemArray[0].ToString(), prodN1Row.ItemArray[1].ToString(),
           prodN1Row.ItemArray[2].ToString(),
    ...
    protected void rptProdN2_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.ProductsN2.AddProductsN2Row(prodN2Row.ItemArray[0].ToString(), prodN2Row.ItemArray[1].ToString(),
