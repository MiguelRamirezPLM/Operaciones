<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="IndiceAS.aspx.cs" Inherits="_Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Índices DEF 55</title>
...
<body>
    ...
    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Strikeout="False"
            ForeColor="#0000C0" Text="ÍNDICE DE SUSTANCIAS ACTIVAS DEF 55"></asp:Label><br />
        <br />
                            ...
                            <asp:Repeater runat="server" ID="rptProds" OnItemDataBound="rptProds_ItemDataBound" >
                                <ItemTemplate>                   
                                   ...
                                   <%-- <asp:Label runat="server" ID="lblDesc" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "Description")%>.</asp:Label>--%>
                                    ...
                                    <%--<asp:Label runat="server" ID="Label4" CssClass="label"><%# DataBinder.Eval(Container.DataItem, "PAGE")%>.</asp:Label>  --%>                       
                                    </td><br />    
                                    </tr></table>
                                </ItemTemplate>
                            </asp:Repeater>
