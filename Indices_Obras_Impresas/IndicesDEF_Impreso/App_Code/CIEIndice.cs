...
public class CIEIndice : PLMDataAccessAdapter<object>
{
    ...
    public DataTable getCIEByParentId(int parentId, int editionId)
    {
        ...
        sb.Append("\n select distinct i.SpanishDescription, i.ICDKey, i.ICDId,  i.ICDKey + ' - ' + i.SpanishDescription as CIE from plm_vwProductsByEdition t ");
            sb.Append("\n join ProductICD picd on t.ProductId= picd.ProductId and  t.pharmaformid = picd.pharmaformid ");
            sb.Append("\n join ICD i on picd.ICDId=i.ICDId ");
            sb.Append("\n where t.EditionId= " + editionId + " and page is not null and i.ParentId=" + parentId);            
            sb.Append("\n order by i.icdkey ");
    ...
    public DataTable getCIEByParentIdN2(int parentId, int editionId)
    {
        ...
        sb.Append("\n select distinct  icd1.SpanishDescription, icd1.ICDKey, icd1.ICDId,  icd1.ICDKey + ' - ' + icd1.SpanishDescription as CIE  ");
            ...
            sb.Append("\n where t.EditionId= " + editionId + "  and page is not null and icd1.ParentId =" + parentId);
            sb.Append("\n ORDER by 2 ");
    ...
    public DataTable getInformation(int ICDId, int editionId)
    {
        ...
        sb.Append("\n select distinct t.Brand, t.CountryCodes, ");
        sb.Append("\n dbo.plm_dfGetActiveSubsByProduct(t.ProductId) AS ACTIVESUBSTANCES , ");
        sb.Append("\n dbo.plm_dfGetPharmaFormsByPagedProduct(t.ProductId, t.EditionId, t.DivisionId) as PHARMAFORMS , t.DivisionName, ");
        sb.Append("\n dbo.plm_dfGetPagesByProduct(t.ProductId, t.EditionId, t.DivisionId) AS PAGE ");
        sb.Append("\n from plm_vwProductsByEdition t ");
        sb.Append("\n join ProductICD picd on t.ProductId= picd.ProductId and  t.pharmaformid = picd.pharmaformid ");
        sb.Append("\n where t.EditionId=" + editionId + " and page is not null and t.typeInEdition = 'p' and picd.ICDId=" + ICDId);
        sb.Append("\n ORDER by 1");
    ...
    public DataTable getAlphabetCIE(int editionId)
    {
        ...
        sb.Append("Select Distinct i.SpanishDescription, i.ICDKey, i.ICDId, i.ICDKey + ' - ' + i.SpanishDescription as CIE from icd i ");
