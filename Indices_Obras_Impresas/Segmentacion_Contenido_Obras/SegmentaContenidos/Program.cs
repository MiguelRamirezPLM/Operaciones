...
namespace SegmentaContenidos
{
    class Program
    {
        ...
        /// <summary>
        /// Metodo que lee archivo html y lo actualiza en ProductContents
        /// </summary>
        ...
        public static Boolean Step1InsertHTMLfromFile(string NameTableTmp,string UrlPath,int EditionId)
        {
            Boolean Correcto = true;
            int Actualizados=0, NoActualizados = 0;
            String sSQL = "Select ProductId, PharmaFormId, DivisionId, CategoryId, HTMLFile from "+NameTableTmp;
            ...
            while(iDReader.Read())
            {
                ...
                htmlfile = iDReader["HTMLFile"].ToString();
                ...
                if (File.Exists(UrlPath+@"\" + htmlfile))
                {
                    ...
                    String sSQLUpdate = " Update ParticipantProducts " +
        ...
        /// <returns></returns>
        public static Boolean Step2ExportHTMLfromDB(int EditionId,string UrlPathDestination)
        {
            int i = 0;
            Boolean correcto = true;
            try
            {
                String sSQL = "Select * from participantProducts where editionid = "+EditionId+" and HTMLContent is not null";
                String cadena = "";
                IDataReader iDReader = ConnectionDB.ExecuteReader(CommandType.Text, sSQL);
        ...
        public static void Step3GenerateXMLfromHTMLDB(string UrlPath,string UrlPathDestination) 
        {
        ...
        /// <returns></returns>
        public static Boolean Step4VerifyXML(string urlPath) 
        {
            Boolean correcto=true;
            DirectoryInfo dir = new System.IO.DirectoryInfo(urlPath+@"\");
        ...
        /// <param name="editionId">Identificador de la edicion</param>
        /// <returns></returns>
        public static Boolean Step5InsertXMLinDB(string urlPath,int editionId)
        {
            DirectoryInfo dir = new System.IO.DirectoryInfo(urlPath);
            String nameFile = "";
            Boolean correcto = true;
        ...
        public static void Step6VerificaRubros()
        { 
            ...
            string sSQL = "Select EditionId, PharmaFormId, ProductId, DivisionId, CategoryId, XMLContent from ParticipantProducts where editionId= ";
                    ...
                    if (i >= 0)
                    {
                        ...
                        if (attributeDescription != "")
                        {
                            sSQL = "INSERT INTO tmpattributes " +
                                       "(Description,info) " +
                                       " VALUES " +
                            "('" + attributeDescription.Replace(":","").Trim().Replace(";","") + "','"+productId+"_"+pharmaId+"')";
                            
                            ConnectionDB.ExecuteNonQuery(CommandType.Text, sSQL);


                            //sSQL1 = "Select top 1 AttributeId from Attributes where Description = '" + attributeDescription.Replace(":", "").Replace(";", "").Trim() + "'";
                        ...
                        if (attributeId != "" && content != "")
                        {
                            ...
                            sSQL2 = "INSERT INTO [tmpproductContentsCloster] " +
                                    "       ([ProductId] " +
                                    "       ,[AttributeId] " +
                                    "       ,[Content] " +
                                    "       ,[EditionId] " +
        ...
        public static int insertXMLToDB(String contenido, String productId, String pharmaFormId,int editionId)
        {
            String sSQL = "";
            int inserted = 0;
                sSQL = "Update ParticipantProducts " +
