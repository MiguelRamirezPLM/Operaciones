...
public partial class Indices : System.Web.UI.Page
{
    ...
    protected void btnNC_Click(object sender, EventArgs e)
    {
        ...
        IndLetters generateNC = new IndLetters(this.Server.MapPath("./HtmlTemplates/Indices/lettersNC.htm"), this.Server.MapPath("./Indices/productos"));
    ...
    protected void btnMp_Click(object sender, EventArgs e)
    {
        ...
        IndLetters generateMP = new IndLetters(this.Server.MapPath("./HtmlTemplates/Indices/lettersMP.htm"), this.Server.MapPath("./Indices/indice_MP"));
    ...
    protected void btnMaq_Click(object sender, EventArgs e)
    {
        ...
        IndLetters generateMaq = new IndLetters(this.Server.MapPath("./HtmlTemplates/Indices/Indice.htm"), this.Server.MapPath("./Indices/indice_Maq"));
    ...
    protected void btnCC_Click(object sender, EventArgs e)
    {
        ...
        IndLetters generateCC = new IndLetters(this.Server.MapPath("./HtmlTemplates/Indices/Indice.htm"), this.Server.MapPath("./Indices/indice_CC"));
    ...
    protected void btnEE_Click(object sender, EventArgs e)
    {
        ...
        IndLetters generateEE = new IndLetters(this.Server.MapPath("./HtmlTemplates/Indices/Indice.htm"), this.Server.MapPath("./Indices/indice_EE"));
        generateEE.getHtmlFilesEE(edition, (int)Sections.Envases_Embalajes, "ENVASES Y EMBALAJES");

        CompaniesEE generateCEE = new CompaniesEE(this.Server.MapPath("./HtmlTemplates/Indices/CompaniesEE.htm"), this.Server.MapPath("./Indices/labs"));
    ...
    protected void btnServ_Click(object sender, EventArgs e)
    {
        ...
        IndLetters generateServ = new IndLetters(this.Server.MapPath("./HtmlTemplates/Indices/Indice.htm"), this.Server.MapPath("./Indices/indice_Serv"));
    ...
    protected void btnTerc_Click(object sender, EventArgs e)
    {
        ...
        IndLetters generateDPP = new IndLetters(this.Server.MapPath("./HtmlTemplates/Indices/Terceras.htm"), this.Server.MapPath("./Indices/terceras"));
