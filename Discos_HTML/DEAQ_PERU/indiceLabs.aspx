<%@ Page Language="C#" AutoEventWireup="true" CodeFile="indiceLabs.aspx.cs" Inherits="indiceLabs" %>
...
<body  onLoad="MM_preloadImages('../letras/a2.gif','../letras/z2.gif','../letras/b2.gif','../letras/c2.gif','../letras/d2.gif','../letras/e2.gif','../letras/f2.gif','../letras/g2.gif','../letras/h2.gif','../letras/i2.gif','../letras/j2.gif','../letras/k2.gif','../letras/l2.gif','../letras/m2.gif','../letras/o2.gif','../letras/p2.gif','../letras/q2.gif','../letras/r2.gif','../letras/s2.gif','../letras/t2.gif','../letras/u2.gif','../letras/v2.gif','../letras/w2.gif','../letras/x2.gif','../letras/y2.gif','../letras/n2.gif','../letras/&ntilde;2.gif')">
    ...
    <table width='100%' border='0' cellpadding='0' cellspacing='0' bordercolor='#111111' style='border-collapse: collapse'>
      <tr align='center' valign='middle'>
         ...
         <th width='20' height='20' scope='col'><a href='no.htm' title='J' target='adentro'><img src='../letras/j1.gif' name='Image110'  onMouseOver="MM_swapImage('Image110','','../letras/j2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         <th width='20' height='20' scope='col'><a href='no.htm' title='K' target='adentro'><img src='../letras/k1.gif' name='Image111'  onMouseOver="MM_swapImage('Image111','','../letras/k2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         ...
         <th width='20' height='20' scope='col'><a href='no.htm' title='O' target='adentro'><img src='../letras/o1.gif' name='Image115'  onMouseOver="MM_swapImage('Image115','','../letras/o2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         ...
         <th width='20' height='20' scope='col'><a href='no.htm' title='T' target='adentro'><img src='../letras/t1.gif' name='Image120'  onMouseOver="MM_swapImage('Image120','','../letras/t2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         <th width='20' height='20' scope='col'><a href='no.htm' title='U' target='adentro'><img src='../letras/u1.gif' name='Image121'  onMouseOver="MM_swapImage('Image121','','../letras/u2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         ...
         <th width='20' height='20' scope='col'><a href='no.htm' title='W' target='adentro'><img src='../letras/w1.gif' name='Image123'  onMouseOver="MM_swapImage('Image123','','../letras/w2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         <th width='20' height='20' scope='col'><a href='no.htm' title='X' target='adentro'><img src='../letras/x1.gif' name='Image124'  onMouseOver="MM_swapImage('Image124','','../letras/x2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         <th width='20' height='20' scope='col'><a href='no.htm' title='Y' target='adentro'><img src='../letras/y1.gif' name='Image125'  onMouseOver="MM_swapImage('Image125','','../letras/y2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         <th width='20' height='20' scope='col'><a href='no.htm' title='Z' target='adentro'><img src='../letras/z1.gif' name='Image1'  onMouseOver="MM_swapImage('Image1','','../letras/z2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         </tr>
      <tr align='center' valign='middle'> </tr>
    </table>
    <p align='center' class='titulo'>&Iacute;NDICE DE LABORATORIOS</p>
    <p align='center'><asp:Label ID="lblLetter" runat="server"></asp:Label></p>
    <%--<div style='overflow:auto; width:728px; height:460px;'>--%>
    <div style='overflow:auto;'>
        <asp:Repeater ID="rptLabs" runat="server" >
        <ItemTemplate>
            <p class='LAB'><a href='<%# DataBinder.Eval(Container.DataItem,"ID") + ".htm"%>' target='_self' runat="server"><%# DataBinder.Eval(Container.DataItem, "NombreCorto").ToString().ToUpper() %></a></p>
