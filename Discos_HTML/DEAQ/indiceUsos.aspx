<%@ Page Language="C#" AutoEventWireup="true" CodeFile="indiceUsos.aspx.cs" Inherits="_Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Índice de Usos</title>
...
<body  onLoad="MM_preloadImages('../letras/a2.gif','../letras/z2.gif','../letras/b2.gif','../letras/c2.gif','../letras/d2.gif','../letras/e2.gif','../letras/f2.gif','../letras/g2.gif','../letras/h2.gif','../letras/i2.gif','../letras/j2.gif','../letras/k2.gif','../letras/l2.gif','../letras/m2.gif','../letras/o2.gif','../letras/p2.gif','../letras/q2.gif','../letras/r2.gif','../letras/s2.gif','../letras/t2.gif','../letras/u2.gif','../letras/v2.gif','../letras/w2.gif','../letras/x2.gif','../letras/y2.gif','../letras/n2.gif','../letras/&ntilde;2.gif')">
    ...
    <table width='100%' border='0' cellpadding='0' cellspacing='0' bordercolor='#111111' style='border-collapse: collapse'>
      <tr align='center' valign='middle'>
         ...
         <th width='20' height='20' scope='col'><a href='faltante.htm' title='E' target='adentro'><img src='../letras/e1.gif' name='Image15'  onMouseOver="MM_swapImage('Image15','','../letras/e2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         ...
         <th width='20' height='20' scope='col'><a href='faltante.htm' title='G' target='adentro'><img src='../letras/g1.gif' name='Image17'  onMouseOver="MM_swapImage('Image17','','../letras/g2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         ...
         <th width='20' height='20' scope='col'><a href='i.htm' title='I' target='adentro'><img src='../letras/i1.gif' name='Image19'  onMouseOver="MM_swapImage('Image19','','../letras/i2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         ...
         <th width='20' height='20' scope='col'><a href='faltante.htm' title='L' target='adentro'><img src='../letras/l1.gif' name='Image112'  onMouseOver="MM_swapImage('Image112','','../letras/l2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         <th width='20' height='20' scope='col'><a href='faltante.htm' title='M' target='adentro'><img src='../letras/m1.gif' name='Image113'  onMouseOver="MM_swapImage('Image113','','../letras/m2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         <th width='20' height='20' scope='col'><a href='faltante.htm' title='N' target='adentro'><img src='../letras/n1.gif' name='Image114'  onMouseOver="MM_swapImage('Image114','','../letras/n2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         <th width='20' height='20' scope='col'><a href='faltante.htm' title='O' target='adentro'><img src='../letras/o1.gif' name='Image115'  onMouseOver="MM_swapImage('Image115','','../letras/o2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         ...
         <th width='20' height='20' scope='col'><a href='faltante.htm' title='T' target='adentro'><img src='../letras/t1.gif' name='Image120'  onMouseOver="MM_swapImage('Image120','','../letras/t2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         <th width='20' height='20' scope='col'><a href='faltante.htm' title='U' target='adentro'><img src='../letras/u1.gif' name='Image121'  onMouseOver="MM_swapImage('Image121','','../letras/u2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
         <th width='20' height='20' scope='col'><a href='faltante.htm' title='V' target='adentro'><img src='../letras/v1.gif' name='Image122'  onMouseOver="MM_swapImage('Image122','','../letras/v2.gif',1)" onMouseOut="MM_swapImgRestore()" border='0'></a></th>
    ...
    <p align='center' class='Titulo'>ÍNDICE DE USOS</p>
    ...
    <div style='overflow:auto;'>
        ...
        <ItemTemplate>
            <p class='USO'><a href="#" id="displayChildren_0" target='_self' runat="server"><%# DataBinder.Eval(Container.DataItem, "USO").ToString().ToUpper() %></a></p>
            <ul>
                <div id="s_divLevelChildren_0" runat="server" style="text-align:left; display:none;">
                <asp:Repeater ID="rptProd" runat="server" >
                    <ItemTemplate>
                        
                            <p class="producto"><a class='links' href='..\productos\<%# Eval("ProductId")+"_"+ Eval("PharmaFormID")+".htm" %>' style='text-decoration:none'> <b><%#Eval("PRODUCTO")+"." %></b> <i><%#Eval("PharmaForm")+"." %></i> <%# Eval("LABORATORIO") %></a></p>
