...
public partial class Interactions : System.Web.UI.Page
{
    ...
    protected void rptLet_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        DataRow ProductosRow = rowView.Row;
        ...
        _ds.Productos.AddProductosRow(ProductosRow[0].ToString());

        Repeater rptProd = (Repeater)e.Item.FindControl("rptProd");
        rptProd.DataSource = GenIndice.Instance.getProductInteractions(this._editionId, ProductosRow.ItemArray[0].ToString());
        rptProd.DataBind();
        _cont += 1;
    ...
    protected void rptProd_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        _ds.WriteXml(System.Configuration.ConfigurationManager.AppSettings["General"] + "Interacciones.xml");
