<%@ Page Language="C#" AutoEventWireup="true" CodeFile="indiceProductos.aspx.cs" Inherits="indiceProductos" %>
...
<table width='100%' border='0' cellpadding='0' cellspacing='0' bordercolor='#111111' style='border-collapse: collapse'>
  <tr align="center" valign="middle">
    ...
    <th width="20" height="20" scope="col"><a href="j.htm" title="J"><img src="../letras/j1.gif" style="border:none" name="Image110" id="Image110" onmouseover="MM_swapImage('Image110','','../letras/j2.gif',1)" onmouseout="MM_swapImgRestore()" /></a></th>
    ...
    <th width="20" height="20" scope="col"><a href="n.htm" title="N"><img src="../letras/n1.gif" style="border:none" id="Image2" onmouseover="MM_swapImage('Image2','','../letras/n2.gif',1)" onmouseout="MM_swapImgRestore()" /></a></th>
    ...
    <th width="20" height="20" scope="col"><a href="u.htm" title="U"><img src="../letras/u1.gif" style="border:none" name="Image121" id="Image121" onmouseover="MM_swapImage('Image121','','../letras/u2.gif',1)" onmouseout="MM_swapImgRestore()" /></a></th>
    ...
    <th width="20" height="20" scope="col"><a href="w.htm" title="W"><img src="../letras/w1.gif" style="border:none" name="Image123" id="Image123" onmouseover="MM_swapImage('Image123','','../letras/w2.gif',1)" onmouseout="MM_swapImgRestore()" /></a></th>
    <th width="20" height="20" scope="col"><a href="x.htm" title="X"><img src="../letras/x1.gif" style="border:none" name="Image124" id="Image124" onmouseover="MM_swapImage('Image124','','../letras/x2.gif',1)" onmouseout="MM_swapImgRestore()" /></a></th>
    <th width="20" height="20" scope="col"><a href="y.htm" title="Y"><img src="../letras/y1.gif" style="border:none" name="Image125" id="Image125" onmouseover="MM_swapImage('Image125','','../letras/y2.gif',1)" onmouseout="MM_swapImgRestore()" /></a></th>
...
<div align="center" >
  <p class="Titulo">&Iacute;ndice General de productos por nombre comercial </p>
</div>   
    <div style='overflow:auto;'>                     
         <%--<table border='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#111111' cellpadding='0'>                               --%>
            ...
            <asp:Repeater ID="rptLevel_0" runat="server" OnItemDataBound="rptLevel_0_ItemDataBound" >
                <ItemTemplate>                      
                    <%--<tr><td>--%>
                    <p class="producto"><a target='_self' href="<%# Eval("FileName") %>" style='text-decoration:none' class="Producto"><b> <%#Eval("Nombre")+"." %>&nbsp;</b><%#Eval("Registro") + "."%>&nbsp;<%#Eval("Description") + "."%>&nbsp;<i><%#Eval("PharmaForm") + "."%></i>&nbsp;<b><%# Eval("Empresa") %></b></a></p>
                    <%--</td></tr>--%>
                </ItemTemplate>
            </asp:Repeater>           
         <%--</table>            --%>
