...
public abstract class GenerateHTML
{
    ...
    public string replaceAccentsToHtmlCodes(string originalString)
    {
        ...
        sb.Replace("m3M", "3M");
        sb.Replace("KENDALL 1", "KENDALL");
        sb.Replace("c2 Care", "2 Care");
        sb.Replace("EDAN INSTRUMENTS 1", "EDAN INSTRUMENTS");
        sb.Replace("MEDIS 0", "MEDIS");
        sb.Replace("MEDIANA 0", "MEDIANA");
        sb.Replace("QUICKIE -1", "QUICKIE");
       // sb.Replace("b6B INVENT GERMANY", "6B INVENT GERMANY"); 
